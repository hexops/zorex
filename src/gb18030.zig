...
pub const C1 = @enumToInt(enum_unnamed_18.C1);
pub const C2 = @enumToInt(enum_unnamed_18.C2);
pub const C4 = @enumToInt(enum_unnamed_18.C4);
pub const CM = @enumToInt(enum_unnamed_18.CM);
...
pub const GB18030_MAP: [256]u8 = [256]u8{
    @bitCast(u8, @truncate(i8, C1)),
    @bitCast(u8, @truncate(i8, C1)),
    @bitCast(u8, @truncate(i8, C1)),
    @bitCast(u8, @truncate(i8, C1)),
    @bitCast(u8, @truncate(i8, C1)),
...
pub fn gb18030_mbc_enc_len(arg_p: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
    if (@bitCast(c_int, @as(c_uint, GB18030_MAP[p.?.*])) != CM) return 1;
    p += 1;
    if (@bitCast(c_int, @as(c_uint, GB18030_MAP[p.?.*])) == C4) return 4;
    return 2;
}
pub fn gb18030_code_to_mbclen(arg_code: OnigCodePoint) callconv(.C) c_int {
    var code = arg_code;
    if ((code & @as(c_uint, 4278190080)) != @bitCast(c_uint, @as(c_int, 0))) {
        if (@bitCast(c_int, @as(c_uint, GB18030_MAP[@intCast(c_uint, (@bitCast(c_int, (code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 24))) & @as(c_int, 255)))])) == CM) if (@bitCast(c_int, @as(c_uint, GB18030_MAP[@intCast(c_uint, (@bitCast(c_int, (code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 16))) & @as(c_int, 255)))])) == C4) return 4;
    } else if ((code & @bitCast(c_uint, @as(c_int, 16711680))) != @bitCast(c_uint, @as(c_int, 0))) return -@as(c_int, 400) else if ((code & @bitCast(c_uint, @as(c_int, 65280))) != @bitCast(c_uint, @as(c_int, 0))) {
        if (@bitCast(c_int, @as(c_uint, GB18030_MAP[@intCast(c_uint, (@bitCast(c_int, (code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 8))) & @as(c_int, 255)))])) == CM) {
            var c: u8 = GB18030_MAP[@intCast(c_uint, (@bitCast(c_int, code) & @as(c_int, 255)))];
            if ((@bitCast(c_int, @as(c_uint, c)) == CM) or (@bitCast(c_int, @as(c_uint, c)) == C2)) return 2;
        }
    } else {
        if (@bitCast(c_int, @as(c_uint, GB18030_MAP[@intCast(c_uint, @bitCast(c_int, (code & @bitCast(c_uint, @as(c_int, 255)))))])) != CM) return 1;
    }
    return -@as(c_int, 400);
}
pub fn is_valid_mbc_string(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    ...
    while (p < end) {
        if (@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 128)) {
            p += 1;
        } else if ((@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 128)) or (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 255))) {
            return 0;
        } else {
            p += 1;
            if (p >= end) return 0;
            if (@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 64)) {
                if ((@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 48)) or (@bitCast(c_int, @as(c_uint, p.?.*)) > @as(c_int, 57))) return 0;
                p += 1;
                if (p >= end) return 0;
                if ((@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 129)) or (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 255))) return 0;
                p += 1;
                if (p >= end) return 0;
                if ((@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 48)) or (@bitCast(c_int, @as(c_uint, p.?.*)) > @as(c_int, 57))) return 0;
                p += 1;
            } else if ((@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 127)) or (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 255))) {
                return 0;
            } else {
                p += 1;
            }
...
pub fn gb18030_mbc_to_code(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) OnigCodePoint {
    var p = arg_p;
    var end = arg_end;
    return onigenc_mbn_mbc_to_code((&OnigEncodingGB18030), p, end);
}
pub fn gb18030_code_to_mbc(arg_code: OnigCodePoint, arg_buf: [*c]OnigUChar) callconv(.C) c_int {
    var code = arg_code;
    var buf = arg_buf;
    return onigenc_mb4_code_to_mbc((&OnigEncodingGB18030), code, buf);
}
pub fn gb18030_mbc_case_fold(arg_flag: OnigCaseFoldType, arg_pp: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_lower: [*c]OnigUChar) callconv(.C) c_int {
    var flag = arg_flag;
    var pp = arg_pp;
    var end = arg_end;
    var lower = arg_lower;
    return onigenc_mbn_mbc_case_fold((&OnigEncodingGB18030), flag, pp, end, lower);
}
pub fn gb18030_is_code_ctype(arg_code: OnigCodePoint, arg_ctype: c_uint) callconv(.C) c_int {
    var code = arg_code;
    var ctype = arg_ctype;
    return onigenc_mb4_is_code_ctype((&OnigEncodingGB18030), code, ctype);
}
pub const S_START = @enumToInt(enum_state.S_START);
pub const S_one_C2 = @enumToInt(enum_state.S_one_C2);
pub const S_one_C4 = @enumToInt(enum_state.S_one_C4);
pub const S_one_CM = @enumToInt(enum_state.S_one_CM);
pub const S_odd_CM_one_CX = @enumToInt(enum_state.S_odd_CM_one_CX);
pub const S_even_CM_one_CX = @enumToInt(enum_state.S_even_CM_one_CX);
pub const S_one_CMC4 = @enumToInt(enum_state.S_one_CMC4);
pub const S_odd_CMC4 = @enumToInt(enum_state.S_odd_CMC4);
pub const S_one_C4_odd_CMC4 = @enumToInt(enum_state.S_one_C4_odd_CMC4);
pub const S_even_CMC4 = @enumToInt(enum_state.S_even_CMC4);
pub const S_one_C4_even_CMC4 = @enumToInt(enum_state.S_one_C4_even_CMC4);
pub const S_odd_CM_odd_CMC4 = @enumToInt(enum_state.S_odd_CM_odd_CMC4);
pub const S_even_CM_odd_CMC4 = @enumToInt(enum_state.S_even_CM_odd_CMC4);
pub const S_odd_CM_even_CMC4 = @enumToInt(enum_state.S_odd_CM_even_CMC4);
pub const S_even_CM_even_CMC4 = @enumToInt(enum_state.S_even_CM_even_CMC4);
pub const S_odd_C4CM = @enumToInt(enum_state.S_odd_C4CM);
pub const S_one_CM_odd_C4CM = @enumToInt(enum_state.S_one_CM_odd_C4CM);
pub const S_even_C4CM = @enumToInt(enum_state.S_even_C4CM);
pub const S_one_CM_even_C4CM = @enumToInt(enum_state.S_one_CM_even_C4CM);
pub const S_even_CM_odd_C4CM = @enumToInt(enum_state.S_even_CM_odd_C4CM);
pub const S_odd_CM_odd_C4CM = @enumToInt(enum_state.S_odd_CM_odd_C4CM);
pub const S_even_CM_even_C4CM = @enumToInt(enum_state.S_even_CM_even_C4CM);
pub const S_odd_CM_even_C4CM = @enumToInt(enum_state.S_odd_CM_even_C4CM);
pub const enum_state = extern enum(c_int) {
    ...
    S_one_C4_odd_CMC4 = 8,
    S_even_CMC4 = 9,
    S_one_C4_even_CMC4 = 10,
    S_odd_CM_odd_CMC4 = 11,
    S_even_CM_odd_CMC4 = 12,
    S_odd_CM_even_CMC4 = 13,
    S_even_CM_even_CMC4 = 14,
    S_odd_C4CM = 15,
    S_one_CM_odd_C4CM = 16,
    S_even_C4CM = 17,
    S_one_CM_even_C4CM = 18,
    S_even_CM_odd_C4CM = 19,
    S_odd_CM_odd_C4CM = 20,
    S_even_CM_even_C4CM = 21,
    S_odd_CM_even_C4CM = 22,
    _,
};
pub const gb18030_left_adjust_char_head = @compileError("unable to translate function"); // ../oniguruma/src/gb18030.c:244:1
pub fn gb18030_is_allowed_reverse_match(arg_s: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var s = arg_s;
    var end = arg_end;
    return if (@bitCast(c_int, @as(c_uint, GB18030_MAP[s.?.*])) == C1) @as(c_int, 1) else @as(c_int, 0);
}
...
pub const DEBUG_OUT = @compileError("unable to translate C expr: unexpected token .Nl"); // ../oniguruma/src/gb18030.c:37:9
