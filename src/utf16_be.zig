...
pub fn init() callconv(.C) c_int {
    ...
    name = "\x00F\x00A\x00I\x00L\x00\x00";
    while (true) {
    ...
    name = "\x00M\x00I\x00S\x00M\x00A\x00T\x00C\x00H\x00\x00";
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
    ...
    name = "\x00E\x00R\x00R\x00O\x00R\x00\x00";
    ...
    name = "\x00C\x00O\x00U\x00N\x00T\x00\x00";
    ...
    name = "\x00T\x00O\x00T\x00A\x00L\x00_\x00C\x00O\x00U\x00N\x00T\x00\x00";
    args[@intCast(c_uint, @as(c_int, 0))] = @bitCast(c_uint, ONIG_TYPE_CHAR);
    opts[@intCast(c_uint, @as(c_int, 0))].c = @bitCast(OnigCodePoint, @as(c_int, '>'));
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
...
pub fn utf16be_mbc_enc_len(arg_p: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
    return EncLen_UTF16[p.?.*];
}
pub fn is_valid_mbc_string(arg_s: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var s = arg_s;
    var end = arg_end;
    while (s < end) {
        var len: c_int = utf16be_mbc_enc_len(s);
        if (len == @as(c_int, 4)) {
            if ((s + @as(c_int, 2)) >= end) return 0;
            if (!((@bitCast(c_int, @as(c_uint, ((s + @as(c_int, 2)).?.*))) & @as(c_int, 252)) == @as(c_int, 220))) return 0;
        } else if ((@bitCast(c_int, @as(c_uint, (s.?.*))) & @as(c_int, 252)) == @as(c_int, 220)) return 0;
        s += len;
    }
    if (s != end) return 0 else return 1;
    return 0;
}
pub fn utf16be_is_mbc_newline(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
    var end = arg_end;
    if ((p + @as(c_int, 1)) < end) {
        if ((@bitCast(c_int, @as(c_uint, (p + @as(c_int, 1)).?.*)) == @as(c_int, 10)) and (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 0))) return 1;
    }
    return 0;
}
pub fn utf16be_mbc_to_code(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) OnigCodePoint {
    var p = arg_p;
    var end = arg_end;
    var code: OnigCodePoint = undefined;
    if ((@bitCast(c_int, @as(c_uint, (p.?.*))) & @as(c_int, 252)) == @as(c_int, 216)) {
        code = @bitCast(OnigCodePoint, (((((((@bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 0))])) - @as(c_int, 216)) << @intCast(@import("std").math.Log2Int(c_int), 2)) + ((@bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 1))])) & @as(c_int, 192)) >> @intCast(@import("std").math.Log2Int(c_int), 6))) + @as(c_int, 1)) << @intCast(@import("std").math.Log2Int(c_int), 16)) + ((((@bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 1))])) & @as(c_int, 63)) << @intCast(@import("std").math.Log2Int(c_int), 2)) + (@bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 2))])) - @as(c_int, 220))) << @intCast(@import("std").math.Log2Int(c_int), 8))) + @bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 3))]))));
    } else {
        code = @bitCast(OnigCodePoint, ((@bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 0))])) * @as(c_int, 256)) + @bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 1))]))));
    }
    return code;
}
pub fn utf16be_code_to_mbclen(arg_code: OnigCodePoint) callconv(.C) c_int {
    var code = arg_code;
...
pub fn utf16be_code_to_mbc(arg_code: OnigCodePoint, arg_buf: [*c]OnigUChar) callconv(.C) c_int {
    var code = arg_code;
    var buf = arg_buf;
    ...
    if (code > @bitCast(c_uint, @as(c_int, 65535))) {
        ...
        (blk: {
            ...
            ref.* += 1;
            break :blk tmp;
        }).?.* = @bitCast(OnigUChar, @truncate(u8, ((high & @bitCast(c_uint, @as(c_int, 3))) +% @bitCast(c_uint, @as(c_int, 220)))));
        p.?.* = @bitCast(OnigUChar, @truncate(u8, (code & @bitCast(c_uint, @as(c_int, 255)))));
        return 4;
    } else {
        (blk: {
            const ref = &p;
            ...
            ref.* += 1;
            break :blk tmp;
        }).?.* = @bitCast(OnigUChar, @truncate(u8, ((code & @bitCast(c_uint, @as(c_int, 65280))) >> @intCast(@import("std").math.Log2Int(c_uint), 8))));
        p.?.* = @bitCast(OnigUChar, @truncate(u8, (code & @bitCast(c_uint, @as(c_int, 255)))));
        return 2;
    }
    return 0;
}
pub fn utf16be_mbc_case_fold(arg_flag: OnigCaseFoldType, arg_pp: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_fold: [*c]OnigUChar) callconv(.C) c_int {
    var flag = arg_flag;
    var pp = arg_pp;
    var end = arg_end;
    var fold = arg_fold;
    var p: [*c]const OnigUChar = pp.?.*;
    if ((@bitCast(c_int, @as(c_uint, ((p + @as(c_int, 1)).?.*))) < @as(c_int, 128)) and (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 0))) {
        p += 1;
        (blk: {
            const ref = &fold;
            const tmp = ref.*;
        ...
        pp.?.* += @as(c_int, 2);
        return 2;
    } else return onigenc_unicode_mbc_case_fold((&OnigEncodingUTF16_BE), flag, pp, end, fold);
    return 0;
}
pub fn utf16be_left_adjust_char_head(arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var start = arg_start;
    var s = arg_s;
    ...
    if ((((@bitCast(c_int, @as(c_uint, (s.?.*))) & @as(c_int, 252)) == @as(c_int, 220)) and (s > (start + @as(c_int, 1)))) and ((@bitCast(c_int, @as(c_uint, ((s - @as(c_int, 2)).?.*))) & @as(c_int, 252)) == @as(c_int, 216))) s -= @as(c_int, 2);
    return @intToPtr([*c]OnigUChar, @ptrToInt(s));
}
pub fn utf16be_get_case_fold_codes_by_str(arg_flag: OnigCaseFoldType, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_items: [*c]OnigCaseFoldCodeItem) callconv(.C) c_int {
    var flag = arg_flag;
    var p = arg_p;
    var end = arg_end;
    var items = arg_items;
    return onigenc_unicode_get_case_fold_codes_by_str((&OnigEncodingUTF16_BE), flag, p, end, items);
}
