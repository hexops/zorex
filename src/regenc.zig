...
pub fn onigenc_step_back(arg_enc: OnigEncoding, arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar, arg_n: c_int) callconv(.C) [*c]OnigUChar {
    var enc = arg_enc;
    var start = arg_start;
    var s = arg_s;
    var n = arg_n;
    while (((@intToPtr(?*c_void, @ptrToInt((s)))) != @intToPtr(?*c_void, @as(c_int, 0))) and ((blk: {
        const ref = &n;
        const tmp = ref.*;
        ref.* -= 1;
        break :blk tmp;
    }) > @as(c_int, 0))) {
        if (s <= start) return @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (@intToPtr(?*c_void, @as(c_int, 0)))));
        s = (enc).*.left_adjust_char_head.?(start, (s - @as(c_int, 1)));
    }
    return @intToPtr([*c]OnigUChar, @ptrToInt(s));
}
pub fn onigenc_init() callconv(.C) c_int {
    if (OnigEncInited != @as(c_int, 0)) return 0;
    OnigEncInited = 1;
    return 0;
}
pub fn onig_initialize_encoding(arg_enc: OnigEncoding) callconv(.C) c_int {
    var enc = arg_enc;
    ...
    if ((enc != (&OnigEncodingASCII)) and (((enc).*.flag & @bitCast(c_uint, (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), 0)))) != @bitCast(c_uint, @as(c_int, 0)))) {
        var ascii: OnigEncoding = (&OnigEncodingASCII);
        if ((ascii.*.init != null) and (enc_is_inited(ascii) == @as(c_int, 0))) {
            r = ascii.*.init.?();
            if (r != @as(c_int, 0)) return r;
            _ = enc_inited_entry(ascii);
        }
    }
    if ((enc.*.init != null) and (enc_is_inited(enc) == @as(c_int, 0))) {
        r = (enc.*.init).?();
        if (r == @as(c_int, 0)) _ = enc_inited_entry(enc);
        return r;
    }
    return 0;
}
pub fn onigenc_set_default_encoding(arg_enc: OnigEncoding) callconv(.C) c_int {
    var enc = arg_enc;
    OnigEncDefaultCharEncoding = enc;
    return 0;
}
pub fn onigenc_get_default_encoding() callconv(.C) OnigEncoding {
    return OnigEncDefaultCharEncoding;
}
pub fn onigenc_set_default_caseconv_table(arg_table: [*c]const OnigUChar) callconv(.C) void {
    var table = arg_table;
}
pub fn onigenc_get_right_adjust_char_head_with_prev(arg_enc: OnigEncoding, arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar, arg_prev: [*c][*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var enc = arg_enc;
    var start = arg_start;
    var s = arg_s;
    var prev = arg_prev;
    var p: [*c]OnigUChar = (enc).*.left_adjust_char_head.?(start, s);
    if (p < @intToPtr([*c]OnigUChar, @ptrToInt(s))) {
        if (prev != null) prev.?.* = @ptrCast([*c]const OnigUChar, @alignCast(@alignOf(OnigUChar), p));
        p += (enc).*.mbc_enc_len.?(p);
    } else {
        if (prev != null) prev.?.* = onigenc_get_prev_char_head(enc, start, p);
    }
    return p;
}
pub fn onigenc_get_prev_char_head(arg_enc: OnigEncoding, arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var enc = arg_enc;
    var start = arg_start;
    var s = arg_s;
    if (s <= start) return @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (@intToPtr(?*c_void, @as(c_int, 0)))));
    return (enc).*.left_adjust_char_head.?(start, (s - @as(c_int, 1)));
}
pub fn onigenc_get_left_adjust_char_head(arg_enc: OnigEncoding, arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var enc = arg_enc;
    var start = arg_start;
    var s = arg_s;
    return (enc).*.left_adjust_char_head.?(start, s);
}
pub fn onigenc_get_right_adjust_char_head(arg_enc: OnigEncoding, arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var enc = arg_enc;
    var start = arg_start;
    var s = arg_s;
    var p: [*c]OnigUChar = (enc).*.left_adjust_char_head.?(start, s);
...
pub fn onigenc_strlen(arg_enc: OnigEncoding, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var p = arg_p;
    var end = arg_end;
    var n: c_int = 0;
    var q: [*c]OnigUChar = @intToPtr([*c]OnigUChar, @ptrToInt(p));
    while (q < @intToPtr([*c]OnigUChar, @ptrToInt(end))) {
        q += (enc).*.mbc_enc_len.?(q);
        n += 1;
    }
    return n;
}
pub fn onigenc_strlen_null(arg_enc: OnigEncoding, arg_s: [*c]const OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var s = arg_s;
    var n: c_int = 0;
    var p: [*c]OnigUChar = @intToPtr([*c]OnigUChar, @ptrToInt(s));
    while (true) {
        if (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, '\x00')) {
            var q: [*c]OnigUChar = undefined;
            var len: c_int = ((enc).*.min_enc_len);
            if (len == @as(c_int, 1)) return n;
            q = (p + @as(c_int, 1));
            while (len > @as(c_int, 1)) {
                if (@bitCast(c_int, @as(c_uint, q.?.*)) != @as(c_int, '\x00')) break;
                q += 1;
                len -= 1;
            }
            if (len == @as(c_int, 1)) return n;
...
pub fn onigenc_str_bytelen_null(arg_enc: OnigEncoding, arg_s: [*c]const OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var s = arg_s;
    var start: [*c]const OnigUChar = s;
    var p: [*c]const OnigUChar = s;
    while (true) {
        if (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, '\x00')) {
            var q: [*c]const OnigUChar = undefined;
            var len: c_int = ((enc).*.min_enc_len);
            if (len == @as(c_int, 1)) return @bitCast(c_int, @truncate(c_int, (p - start)));
            q = (p + @as(c_int, 1));
            while (len > @as(c_int, 1)) {
                if (@bitCast(c_int, @as(c_uint, q.?.*)) != @as(c_int, '\x00')) break;
                q += 1;
...
pub fn onigenc_is_valid_mbc_string(arg_enc: OnigEncoding, arg_s: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var s = arg_s;
    var end = arg_end;
    return (enc).*.is_valid_mbc_string.?(s, end);
}
pub fn onigenc_strdup(arg_enc: OnigEncoding, arg_s: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var enc = arg_enc;
    var s = arg_s;
    var end = arg_end;
    var slen: c_int = undefined;
    var term_len: c_int = undefined;
    var i: c_int = undefined;
    var r: [*c]OnigUChar = undefined;
    slen = @bitCast(c_int, @truncate(c_int, (end - s)));
    term_len = ((enc).*.min_enc_len);
    r = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), malloc(@bitCast(c_ulong, @as(c_long, (slen + term_len))))));
    if ((@ptrCast(?*c_void, (r))) == @intToPtr(?*c_void, @as(c_int, 0))) return null;
    _ = __builtin___memcpy_chk(@ptrCast(?*c_void, r), @ptrCast(?*const c_void, s), @bitCast(c_ulong, @as(c_long, slen)), __builtin_object_size(@ptrCast(?*const c_void, r), @as(c_int, 0)));
    {
        i = 0;
        while (i < term_len) : (i += 1) r[@intCast(c_uint, (slen + i))] = @bitCast(OnigUChar, @truncate(i8, @as(c_int, 0)));
    }
    return r;
}
...
pub fn onigenc_end() callconv(.C) c_int {
    var i: c_int = undefined;
    {
        i = 0;
        while (i < InitedListNum) : (i += 1) {
            InitedList[@intCast(c_uint, i)].enc = null;
            InitedList[@intCast(c_uint, i)].inited = 0;
        }
    }
    InitedListNum = 0;
    OnigEncInited = 0;
...
pub fn onigenc_ascii_apply_all_case_fold(arg_flag: OnigCaseFoldType, arg_f: OnigApplyAllCaseFoldFunc, arg_arg: ?*c_void) callconv(.C) c_int {
    var flag = arg_flag;
    var f = arg_f;
    var arg = arg_arg;
    ...
    {
        i = 0;
        while (i < @bitCast(c_int, @truncate(c_uint, (@sizeOf([26]OnigPairCaseFoldCodes) / @sizeOf(OnigPairCaseFoldCodes))))) : (i += 1) {
            code = OnigAsciiLowerMap[@intCast(c_uint, i)].to;
            r = (f).?(OnigAsciiLowerMap[@intCast(c_uint, i)].from, &code, @as(c_int, 1), arg);
            if (r != @as(c_int, 0)) return r;
            code = OnigAsciiLowerMap[@intCast(c_uint, i)].from;
            r = (f).?(OnigAsciiLowerMap[@intCast(c_uint, i)].to, &code, @as(c_int, 1), arg);
            if (r != @as(c_int, 0)) return r;
        }
    }
    return 0;
}
pub fn onigenc_ascii_get_case_fold_codes_by_str(arg_flag: OnigCaseFoldType, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_items: [*c]OnigCaseFoldCodeItem) callconv(.C) c_int {
    var flag = arg_flag;
    var p = arg_p;
    var end = arg_end;
    var items = arg_items;
    if ((@as(c_int, 65) <= @bitCast(c_int, @as(c_uint, p.?.*))) and (@bitCast(c_int, @as(c_uint, p.?.*)) <= @as(c_int, 90))) {
        items[@intCast(c_uint, @as(c_int, 0))].byte_len = 1;
        items[@intCast(c_uint, @as(c_int, 0))].code_len = 1;
        items[@intCast(c_uint, @as(c_int, 0))].code[@intCast(c_uint, @as(c_int, 0))] = @bitCast(OnigCodePoint, (@bitCast(c_int, @as(c_uint, p.?.*)) + @as(c_int, 32)));
        return 1;
    } else if ((@as(c_int, 97) <= @bitCast(c_int, @as(c_uint, p.?.*))) and (@bitCast(c_int, @as(c_uint, p.?.*)) <= @as(c_int, 122))) {
        items[@intCast(c_uint, @as(c_int, 0))].byte_len = 1;
        items[@intCast(c_uint, @as(c_int, 0))].code_len = 1;
        items[@intCast(c_uint, @as(c_int, 0))].code[@intCast(c_uint, @as(c_int, 0))] = @bitCast(OnigCodePoint, (@bitCast(c_int, @as(c_uint, p.?.*)) - @as(c_int, 32)));
        return 1;
...
pub fn onigenc_apply_all_case_fold_with_map(arg_map_size: c_int, map: [*c]const OnigPairCaseFoldCodes, arg_ess_tsett_flag: c_int, arg_flag: OnigCaseFoldType, arg_f: OnigApplyAllCaseFoldFunc, arg_arg: ?*c_void) callconv(.C) c_int {
    var map_size = arg_map_size;
    var ess_tsett_flag = arg_ess_tsett_flag;
    var flag = arg_flag;
    var f = arg_f;
    var arg = arg_arg;
    var code: OnigCodePoint = undefined;
    ...
    if (r != @as(c_int, 0)) return r;
    if (((flag) & @bitCast(c_uint, (@as(c_int, 1)))) != @bitCast(c_uint, @as(c_int, 0))) return 0;
    {
        i = 0;
        while (i < map_size) : (i += 1) {
            code = map[@intCast(c_uint, i)].to;
            r = (f).?(map[@intCast(c_uint, i)].from, &code, @as(c_int, 1), arg);
            if (r != @as(c_int, 0)) return r;
            code = map[@intCast(c_uint, i)].from;
            r = (f).?(map[@intCast(c_uint, i)].to, &code, @as(c_int, 1), arg);
            if (r != @as(c_int, 0)) return r;
        }
    }
    if (ess_tsett_flag != @as(c_int, 0)) return ss_apply_all_case_fold(flag, f, arg);
    return 0;
} // ../oniguruma/src/regenc.c:604:5: warning: TODO implement translation of stmt class LabelStmtClass
if (p <end)) ) {if(p. @as(c_uint, ))==@as ?.*
    @bitCast,
    c_int,
,(c_int, 1;;} ;return0; 10))) )return}pub onigenc_ascii_mbc_case_fold(
pub const onigenc_get_case_fold_codes_by_str_with_map = @compileError("unable to translate function"); // ../oniguruma/src/regenc.c:592:1
pub fn onigenc_not_support_get_ctype_code_range(arg_ctype: OnigCtype, arg_sb_out: [*c]OnigCodePoint, arg_ranges: [*c][*c]const OnigCodePoint) callconv(.C) c_int {
    var ctype = arg_ctype;
    var sb_out = arg_sb_out;
    var ranges = arg_ranges;
    return -@as(c_int, 2);
}
pub fn onigenc_is_mbc_newline_0x0a(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
    var end = arg_end;
    if (p < end) {
        if (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 10)) return 1;
    }
    return 0;
}
pub fn onigenc_ascii_mbc_case_fold(arg_flag: OnigCaseFoldType, arg_p: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_lower: [*c]OnigUChar) callconv(.C) c_int {
    var flag = arg_flag;
    var p = arg_p;
    var end = arg_end;
    var lower = arg_lower;
...
pub fn onigenc_single_byte_mbc_enc_len(arg_p: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
    return 1;
}
pub fn onigenc_single_byte_mbc_to_code(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) OnigCodePoint {
    var p = arg_p;
    var end = arg_end;
    return @bitCast(OnigCodePoint, @as(c_uint, (p.?.*)));
}
pub fn onigenc_single_byte_code_to_mbclen(arg_code: OnigCodePoint) callconv(.C) c_int {
    var code = arg_code;
    return (if (code < @bitCast(c_uint, @as(c_int, 256))) @as(c_int, 1) else -@as(c_int, 400));
}
pub fn onigenc_single_byte_code_to_mbc(arg_code: OnigCodePoint, arg_buf: [*c]OnigUChar) callconv(.C) c_int {
    var code = arg_code;
    var buf = arg_buf;
    buf.?.* = @bitCast(OnigUChar, @truncate(u8, (code & @bitCast(c_uint, @as(c_int, 255)))));
    return 1;
}
pub fn onigenc_single_byte_left_adjust_char_head(arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var start = arg_start;
    var s = arg_s;
    return @intToPtr([*c]OnigUChar, @ptrToInt(s));
}
pub fn onigenc_always_true_is_allowed_reverse_match(arg_s: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var s = arg_s;
    var end = arg_end;
    return 1;
}
pub fn onigenc_always_false_is_allowed_reverse_match(arg_s: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var s = arg_s;
    var end = arg_end;
    return 0;
}
pub fn onigenc_always_true_is_valid_mbc_string(arg_s: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var s = arg_s;
    var end = arg_end;
    return 1;
}
pub fn onigenc_length_check_is_valid_mbc_string(arg_enc: OnigEncoding, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var p = arg_p;
    var end = arg_end;
    while (p < end) {
    ...
    if (p != end) return 0 else return 1;
    return 0;
}
pub fn onigenc_mbn_mbc_to_code(arg_enc: OnigEncoding, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) OnigCodePoint {
    var enc = arg_enc;
    var p = arg_p;
    var end = arg_end;
    ...
    n = @bitCast(OnigCodePoint, @as(c_uint, ((blk: {
        const ref = &p;
        const tmp = ref.*;
        ref.* += 1;
        break :blk tmp;
    ...
    if (len == @as(c_int, 1)) return n;
    {
        ...
        while (i < len) : (i += 1) {
            if (p >= end) break;
            c = @bitCast(c_int, @as(c_uint, (blk: {
                const ref = &p;
                const tmp = ref.*;
                ref.* += 1;
                break :blk tmp;
            }).?.*));
            n <<= @intCast(@import("std").math.Log2Int(c_int), 8);
            n +%= @bitCast(c_uint, c);
        }
    }
    return n;
}
pub fn onigenc_mbn_mbc_case_fold(arg_enc: OnigEncoding, arg_flag: OnigCaseFoldType, arg_pp: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_lower: [*c]OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var flag = arg_flag;
    var pp = arg_pp;
    var end = arg_end;
    ...
    if (@bitCast(c_int, @as(c_uint, (p).?.*)) < @as(c_int, 128)) {
        lower.?.* = OnigEncAsciiToLowerCaseTable[p.?.*];
        (pp.?.*) += 1;
        return 1;
    } else {
...
pub fn onigenc_mb2_code_to_mbc(arg_enc: OnigEncoding, arg_code: OnigCodePoint, arg_buf: [*c]OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var code = arg_code;
    var buf = arg_buf;
    var p: [*c]OnigUChar = buf;
    if ((code & @bitCast(c_uint, @as(c_int, 65280))) != @bitCast(c_uint, @as(c_int, 0))) {
        (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }).?.* = @bitCast(OnigUChar, @truncate(u8, ((code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 8)) & @bitCast(c_uint, @as(c_int, 255)))));
    }
    (blk: {
        const ref = &p;
        const tmp = ref.*;
        ref.* += 1;
        break :blk tmp;
    }).?.* = @bitCast(OnigUChar, @truncate(u8, (code & @bitCast(c_uint, @as(c_int, 255)))));
    if (@bitCast(c_long, @as(c_long, (enc).*.mbc_enc_len.?(buf))) != (p - buf)) return -@as(c_int, 400);
    return @bitCast(c_int, @truncate(c_int, (p - buf)));
}
var PBS: [15]PosixBracketEntryType = [15]PosixBracketEntryType{
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Alnum")),
        .ctype = ONIGENC_CTYPE_ALNUM,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Alpha")),
        .ctype = ONIGENC_CTYPE_ALPHA,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Blank")),
        .ctype = ONIGENC_CTYPE_BLANK,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Cntrl")),
        .ctype = ONIGENC_CTYPE_CNTRL,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Digit")),
        .ctype = ONIGENC_CTYPE_DIGIT,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Graph")),
        .ctype = ONIGENC_CTYPE_GRAPH,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Lower")),
        .ctype = ONIGENC_CTYPE_LOWER,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Print")),
        .ctype = ONIGENC_CTYPE_PRINT,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Punct")),
        .ctype = ONIGENC_CTYPE_PUNCT,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Space")),
        .ctype = ONIGENC_CTYPE_SPACE,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Upper")),
        .ctype = ONIGENC_CTYPE_UPPER,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "XDigit")),
        .ctype = ONIGENC_CTYPE_XDIGIT,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 6))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "ASCII")),
        .ctype = ONIGENC_CTYPE_ASCII,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 5))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), "Word")),
        .ctype = ONIGENC_CTYPE_WORD,
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 4))),
    },
    PosixBracketEntryType{
        .name = @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (@intToPtr(?*c_void, @as(c_int, 0))))),
        .ctype = -@as(c_int, 1),
        .len = @bitCast(c_short, @truncate(c_short, @as(c_int, 0))),
    },
};
pub fn onigenc_minimum_property_name_to_ctype(arg_enc: OnigEncoding, arg_p: [*c]OnigUChar, arg_end: [*c]OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var p = arg_p;
    var end = arg_end;
    _ = PBS;
    var pb: [*c]PosixBracketEntryType = undefined;
    var len: c_int = undefined;
    len = onigenc_strlen(enc, p, end);
    {
        pb = &PBS;
        while ((@ptrCast(?*c_void, (pb.*.name))) != @intToPtr(?*c_void, @as(c_int, 0))) : (pb += 1) {
            if ((len == @bitCast(c_int, @as(c_int, pb.*.len))) and (onigenc_with_ascii_strncmp(enc, p, end, pb.*.name, @bitCast(c_int, @as(c_int, pb.*.len))) == @as(c_int, 0))) return pb.*.ctype;
        }
    }
    return -@as(c_int, 223);
}
pub extern fn onigenc_unicode_property_name_to_ctype(enc: OnigEncoding, p: [*c]OnigUChar, end: [*c]OnigUChar) c_int;
pub fn onigenc_is_mbc_word_ascii(arg_enc: OnigEncoding, arg_s: [*c]OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var s = arg_s;
    var end = arg_end;
    var code: OnigCodePoint = (enc).*.mbc_to_code.?((s), (end));
    if (code > @bitCast(c_uint, @as(c_int, 127))) return 0;
    return @boolToInt(((@bitCast(c_int, @as(c_uint, OnigEncAsciiCtypeTable[code])) & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (ONIGENC_CTYPE_WORD)))) != @as(c_int, 0)));
}
pub fn onigenc_mb2_is_code_ctype(arg_enc: OnigEncoding, arg_code: OnigCodePoint, arg_ctype: c_uint) callconv(.C) c_int {
    var enc = arg_enc;
    var code = arg_code;
    var ctype = arg_ctype;
    if (code < @bitCast(c_uint, @as(c_int, 128))) return @boolToInt(((@bitCast(c_int, @as(c_uint, OnigEncAsciiCtypeTable[code])) & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (ctype)))) != @as(c_int, 0))) else {
        if ((((ctype) == @bitCast(c_uint, ONIGENC_CTYPE_WORD)) or ((ctype) == @bitCast(c_uint, ONIGENC_CTYPE_GRAPH))) or ((ctype) == @bitCast(c_uint, ONIGENC_CTYPE_PRINT))) {
            return (if ((enc).*.code_to_mbclen.?(code) > @as(c_int, 1)) @as(c_int, 1) else @as(c_int, 0));
        }
    }
    return 0;
}
pub fn onigenc_mb4_code_to_mbc(arg_enc: OnigEncoding, arg_code: OnigCodePoint, arg_buf: [*c]OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var code = arg_code;
    var buf = arg_buf;
    var p: [*c]OnigUChar = buf;
    if ((code & @as(c_uint, 4278190080)) != @bitCast(c_uint, @as(c_int, 0))) {
        (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }).?.* = @bitCast(OnigUChar, @truncate(u8, ((code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 24)) & @bitCast(c_uint, @as(c_int, 255)))));
    }
    if (((code & @bitCast(c_uint, @as(c_int, 16711680))) != @bitCast(c_uint, @as(c_int, 0))) or (p != buf)) {
        (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }).?.* = @bitCast(OnigUChar, @truncate(u8, ((code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 16)) & @bitCast(c_uint, @as(c_int, 255)))));
    }
    if (((code & @bitCast(c_uint, @as(c_int, 65280))) != @bitCast(c_uint, @as(c_int, 0))) or (p != buf)) {
        (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
...
pub fn onigenc_mb4_is_code_ctype(arg_enc: OnigEncoding, arg_code: OnigCodePoint, arg_ctype: c_uint) callconv(.C) c_int {
    var enc = arg_enc;
    var code = arg_code;
    var ctype = arg_ctype;
    if (code < @bitCast(c_uint, @as(c_int, 128))) return @boolToInt(((@bitCast(c_int, @as(c_uint, OnigEncAsciiCtypeTable[code])) & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (ctype)))) != @as(c_int, 0))) else {
...
pub fn onig_codes_cmp(arg_a: [*c]OnigCodePoint, arg_b: [*c]OnigCodePoint, arg_n: c_int) callconv(.C) c_int {
    var a = arg_a;
    var b = arg_b;
    var n = arg_n;
    var i: c_int = undefined;
    {
        i = 0;
        while (i < n) : (i += 1) {
            if (a[@intCast(c_uint, i)] != b[@intCast(c_uint, i)]) return -@as(c_int, 1);
        }
    }
    return 0;
}
pub fn onig_codes_byte_at(arg_codes: [*c]OnigCodePoint, arg_at: c_int) callconv(.C) c_int {
    var codes = arg_codes;
    var at = arg_at;
    var index_1: c_int = undefined;
    var b: c_int = undefined;
    var code: OnigCodePoint = undefined;
    index_1 = @divTrunc(at, @as(c_int, 3));
    b = @rem(at, @as(c_int, 3));
    code = codes[@intCast(c_uint, index_1)];
    return @bitCast(c_int, ((code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), ((@as(c_int, 2) - b) * @as(c_int, 8)))) & @bitCast(c_uint, @as(c_int, 255))));
}
...
pub fn onigenc_with_ascii_strncmp(arg_enc: OnigEncoding, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_sascii: [*c]const OnigUChar, arg_n: c_int) callconv(.C) c_int {
    var enc = arg_enc;
    var p = arg_p;
    var end = arg_end;
    var sascii = arg_sascii;
    var n = arg_n;
    ...
    while ((blk: {
        ...
        if (p >= end) return @bitCast(c_int, @as(c_uint, (sascii.?.*)));
        c = @bitCast(c_int, (enc).*.mbc_to_code.?((p), (end)));
        x = (@bitCast(c_int, @as(c_uint, sascii.?.*)) - c);
        if (x != 0) return x;
        sascii += 1;
        p += (enc).*.mbc_enc_len.?(p);
    }
...
pub fn onigenc_step(arg_enc: OnigEncoding, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_n: c_int) callconv(.C) [*c]OnigUChar {
    var enc = arg_enc;
    var p = arg_p;
    var end = arg_end;
    var n = arg_n;
    ...
    return (if (q <= @intToPtr([*c]OnigUChar, @ptrToInt(end))) q else null);
}
...
pub var InitedListNum: c_int = @import("std").mem.zeroes(c_int);
const struct_unnamed_75 = extern struct {
    enc: OnigEncoding,
    inited: c_int,
};
pub var InitedList: [20]struct_unnamed_75 = @import("std").mem.zeroes([20]struct_unnamed_75);
pub fn enc_inited_entry(arg_enc: OnigEncoding) callconv(.C) c_int {
    var enc = arg_enc;
    var i: c_int = undefined;
    {
        i = 0;
        while (i < InitedListNum) : (i += 1) {
            if (InitedList[@intCast(c_uint, i)].enc == enc) {
                InitedList[@intCast(c_uint, i)].inited = 1;
                return i;
            }
        }
    }
    i = InitedListNum;
    if (i < (@as(c_int, 20) - @as(c_int, 1))) {
        InitedList[@intCast(c_uint, i)].enc = enc;
        InitedList[@intCast(c_uint, i)].inited = 1;
        InitedListNum += 1;
        return i;
    }
...
pub fn enc_is_inited(arg_enc: OnigEncoding) callconv(.C) c_int {
    var enc = arg_enc;
    var i: c_int = undefined;
    {
        i = 0;
        while (i < InitedListNum) : (i += 1) {
            if (InitedList[@intCast(c_uint, i)].enc == enc) {
                return InitedList[@intCast(c_uint, i)].inited;
            }
        }
    }
    return 0;
}
pub var OnigEncInited: c_int = @import("std").mem.zeroes(c_int);
pub export const OnigAsciiLowerMap: [26]OnigPairCaseFoldCodes = [26]OnigPairCaseFoldCodes{
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 65)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 97)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 66)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 98)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 67)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 99)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 68)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 100)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 69)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 101)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 70)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 102)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 71)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 103)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 72)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 104)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 73)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 105)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 74)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 106)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 75)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 107)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 76)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 108)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 77)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 109)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 78)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 110)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 79)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 111)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 80)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 112)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 81)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 113)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 82)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 114)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 83)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 115)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 84)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 116)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 85)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 117)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 86)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 118)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 87)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 119)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 88)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 120)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 89)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 121)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 90)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 122)),
    },
};
var ss: [2]OnigCodePoint = [2]OnigCodePoint{
    @bitCast(OnigCodePoint, @as(c_int, 115)),
    @bitCast(OnigCodePoint, @as(c_int, 115)),
};
pub fn ss_apply_all_case_fold(arg_flag: OnigCaseFoldType, arg_f: OnigApplyAllCaseFoldFunc, arg_arg: ?*c_void) callconv(.C) c_int {
    var flag = arg_flag;
    var f = arg_f;
    var arg = arg_arg;
    _ = ss;
    return (f).?(@bitCast(OnigCodePoint, @as(c_int, 223)), &ss, @as(c_int, 2), arg);
}
...
pub const LARGE_S = 0x53;
pub const SMALL_S = 0x73;
pub const INITED_LIST_SIZE = 20;
