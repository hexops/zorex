...
pub fn onigenc_apply_all_case_fold_with_map(arg_map_size: c_int, map: [*c]const OnigPairCaseFoldCodes, arg_ess_tsett_flag: c_int, arg_flag: OnigCaseFoldType, arg_f: OnigApplyAllCaseFoldFunc, arg_arg: ?*c_void) callconv(.C) c_int {
    ...
    return 0;
} // ./src/todo/regenc.c:604:5: warning: TODO implement translation of stmt class LabelStmtClass
if (p <end)) ) {if(p. @as(c_uint, ))==@as ?.*
    @bitCast,
    c_int,
,(c_int, 1;;} ;return0; 10))) )return}pub onigenc_ascii_mbc_case_fold(
pub const onigenc_get_case_fold_codes_by_str_with_map = @compileError("unable to translate function"); // ./src/todo/regenc.c:592:1
...
pub var InitedList: [20]struct_unnamed_74 = @import("std").mem.zeroes([20]struct_unnamed_74);
