...
pub const EncKOI8_ToLowerCaseTable: [256]OnigUChar = [256]OnigUChar{
    ...
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967201))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967202))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967203))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967204))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967205))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967206))),
    ...
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967228))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967229))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967230))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967231))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967232))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967233))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967234))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967235))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967236))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967237))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967238))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967239))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967240))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967241))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967242))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967243))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967244))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967245))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967246))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967247))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967248))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967249))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967250))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967251))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967252))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967253))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967254))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967255))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967256))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967257))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967258))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967259))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967260))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967261))),
    @bitCast(OnigUChar, @truncate(i8, @as(c_int, 4294967262))),
...
pub const EncKOI8_CtypeTable: [256]c_ushort = [256]c_ushort{
...
pub fn koi8_mbc_case_fold(arg_flag: OnigCaseFoldType, arg_pp: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_lower: [*c]OnigUChar) callconv(.C) c_int {
    var flag = arg_flag;
    var pp = arg_pp;
    var end = arg_end;
    var lower = arg_lower;
    var p: [*c]const OnigUChar = pp.?.*;
    if ((((flag) & @bitCast(c_uint, (@as(c_int, 1)))) == @bitCast(c_uint, @as(c_int, 0))) or (@bitCast(c_int, @as(c_uint, (p.?.*))) < @as(c_int, 128))) lower.?.* = EncKOI8_ToLowerCaseTable[p.?.*] else lower.?.* = p.?.*;
    (pp.?.*) += 1;
    return 1;
}
pub fn koi8_is_code_ctype(arg_code: OnigCodePoint, arg_ctype: c_uint) callconv(.C) c_int {
    var code = arg_code;
    var ctype = arg_ctype;
    if (code < @bitCast(c_uint, @as(c_int, 256))) return @boolToInt(((@bitCast(c_int, @as(c_uint, EncKOI8_CtypeTable[code])) & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (ctype)))) != @as(c_int, 0))) else return 0;
    return 0;
}
pub const CaseFoldMap: [63]OnigPairCaseFoldCodes = [63]OnigPairCaseFoldCodes{
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 223)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 255)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 224)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 192)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 225)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 193)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 226)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 194)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 227)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 195)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 228)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 196)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 229)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 197)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 230)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 198)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 231)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 199)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 232)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 200)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 233)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 201)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 234)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 202)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 235)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 203)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 236)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 204)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 237)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 205)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 238)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 206)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 239)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 207)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 240)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 208)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 241)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 209)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 242)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 210)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 243)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 211)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 244)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 212)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 245)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 213)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 246)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 214)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 247)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 215)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 248)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 216)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 249)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 217)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 250)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 218)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 251)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 219)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 252)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 220)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 254)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 222)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 255)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 223)),
    },
};
pub fn koi8_apply_all_case_fold(arg_flag: OnigCaseFoldType, arg_f: OnigApplyAllCaseFoldFunc, arg_arg: ?*c_void) callconv(.C) c_int {
    var flag = arg_flag;
    var f = arg_f;
    var arg = arg_arg;
    return onigenc_apply_all_case_fold_with_map(@bitCast(c_int, @truncate(c_uint, (@sizeOf([63]OnigPairCaseFoldCodes) / @sizeOf(OnigPairCaseFoldCodes)))), &CaseFoldMap, @as(c_int, 0), flag, f, arg);
}
pub fn koi8_get_case_fold_codes_by_str(arg_flag: OnigCaseFoldType, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_items: [*c]OnigCaseFoldCodeItem) callconv(.C) c_int {
    var flag = arg_flag;
    var p = arg_p;
    var end = arg_end;
    var items = arg_items;
    return onigenc_get_case_fold_codes_by_str_with_map(@bitCast(c_int, @truncate(c_uint, (@sizeOf([63]OnigPairCaseFoldCodes) / @sizeOf(OnigPairCaseFoldCodes)))), &CaseFoldMap, @as(c_int, 0), flag, p, end, items);
}
...
pub fn ENC_KOI8_TO_LOWER_CASE(c: anytype) callconv(.Inline) @TypeOf(EncKOI8_ToLowerCaseTable[c]) {
    return EncKOI8_ToLowerCaseTable[c];
}
pub fn ENC_IS_KOI8_CTYPE(code: anytype, ctype: anytype) callconv(.Inline) @TypeOf((EncKOI8_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0) {
    return (EncKOI8_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0;
}
