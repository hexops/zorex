...
pub const EncCP1251_ToLowerCaseTable: [256]OnigUChar = [256]OnigUChar{
...
pub const EncCP1251_CtypeTable: [256]c_ushort = [256]c_ushort{
    ...
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 16392))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 16392))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 17036))),
    ...
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12514))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12514))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12770))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 416))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 416))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12514))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 0))),
...
pub fn cp1251_mbc_case_fold(arg_flag: OnigCaseFoldType, arg_pp: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_lower: [*c]OnigUChar) callconv(.C) c_int {
    var flag = arg_flag;
    var pp = arg_pp;
    var end = arg_end;
    var lower = arg_lower;
    var p: [*c]const OnigUChar = pp.?.*;
    if ((((flag) & @bitCast(c_uint, (@as(c_int, 1)))) == @bitCast(c_uint, @as(c_int, 0))) or (@bitCast(c_int, @as(c_uint, (p.?.*))) < @as(c_int, 128))) lower.?.* = EncCP1251_ToLowerCaseTable[p.?.*] else lower.?.* = p.?.*;
    (pp.?.*) += 1;
    return 1;
}
pub fn cp1251_is_code_ctype(arg_code: OnigCodePoint, arg_ctype: c_uint) callconv(.C) c_int {
    var code = arg_code;
    var ctype = arg_ctype;
    if (code < @bitCast(c_uint, @as(c_int, 256))) return @boolToInt(((@bitCast(c_int, @as(c_uint, EncCP1251_CtypeTable[code])) & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (ctype)))) != @as(c_int, 0))) else return 0;
    return 0;
}
pub const CaseFoldMap: [33]OnigPairCaseFoldCodes = [33]OnigPairCaseFoldCodes{
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 184)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 253)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 221)),
    },
    OnigPairCaseFoldCodes{
...
pub fn cp1251_apply_all_case_fold(arg_flag: OnigCaseFoldType, arg_f: OnigApplyAllCaseFoldFunc, arg_arg: ?*c_void) callconv(.C) c_int {
    var flag = arg_flag;
    var f = arg_f;
    var arg = arg_arg;
    return onigenc_apply_all_case_fold_with_map(@bitCast(c_int, @truncate(c_uint, (@sizeOf([33]OnigPairCaseFoldCodes) / @sizeOf(OnigPairCaseFoldCodes)))), &CaseFoldMap, @as(c_int, 0), flag, f, arg);
}
pub fn cp1251_get_case_fold_codes_by_str(arg_flag: OnigCaseFoldType, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_items: [*c]OnigCaseFoldCodeItem) callconv(.C) c_int {
    var flag = arg_flag;
    var p = arg_p;
    var end = arg_end;
    var items = arg_items;
    return onigenc_get_case_fold_codes_by_str_with_map(@bitCast(c_int, @truncate(c_uint, (@sizeOf([33]OnigPairCaseFoldCodes) / @sizeOf(OnigPairCaseFoldCodes)))), &CaseFoldMap, @as(c_int, 0), flag, p, end, items);
}
...
pub fn ENC_CP1251_TO_LOWER_CASE(c: anytype) callconv(.Inline) @TypeOf(EncCP1251_ToLowerCaseTable[c]) {
    return EncCP1251_ToLowerCaseTable[c];
}
pub fn ENC_IS_CP1251_CTYPE(code: anytype, ctype: anytype) callconv(.Inline) @TypeOf((EncCP1251_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0) {
    return (EncCP1251_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0;
}
