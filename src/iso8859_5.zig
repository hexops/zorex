...
pub const EncISO_8859_5_ToLowerCaseTable: [256]OnigUChar = [256]OnigUChar{
...
pub const EncISO_8859_5_CtypeTable: [256]c_ushort = [256]c_ushort{
...
pub fn mbc_case_fold(arg_flag: OnigCaseFoldType, arg_pp: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_lower: [*c]OnigUChar) callconv(.C) c_int {
    ...
    if ((((flag) & @bitCast(c_uint, (@as(c_int, 1)))) == @bitCast(c_uint, @as(c_int, 0))) or (@bitCast(c_int, @as(c_uint, (p.?.*))) < @as(c_int, 128))) lower.?.* = EncISO_8859_5_ToLowerCaseTable[p.?.*] else lower.?.* = p.?.*;
    (pp.?.*) += 1;
    return 1;
}
pub fn is_code_ctype(arg_code: OnigCodePoint, arg_ctype: c_uint) callconv(.C) c_int {
    var code = arg_code;
    var ctype = arg_ctype;
    if (code < @bitCast(c_uint, @as(c_int, 256))) return @boolToInt(((@bitCast(c_int, @as(c_uint, EncISO_8859_5_CtypeTable[code])) & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (ctype)))) != @as(c_int, 0))) else return 0;
    return 0;
}
pub const CaseFoldMap: [46]OnigPairCaseFoldCodes = [46]OnigPairCaseFoldCodes{
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 161)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 241)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 162)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 164)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 244)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 165)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 167)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 247)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 168)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 248)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 169)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 171)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 174)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 176)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 208)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 177)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 179)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 181)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 213)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 182)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 214)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 183)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 185)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 217)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 186)),
        .to = @bitCast(OnigCodePoint, @as(c_int, 218)),
    },
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 187)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 189)),
    ...
    OnigPairCaseFoldCodes{
        .from = @bitCast(OnigCodePoint, @as(c_int, 191)),
...
pub fn apply_all_case_fold(arg_flag: OnigCaseFoldType, arg_f: OnigApplyAllCaseFoldFunc, arg_arg: ?*c_void) callconv(.C) c_int {
    ...
    var f = arg_f;
    var arg = arg_arg;
    return onigenc_apply_all_case_fold_with_map(@bitCast(c_int, @truncate(c_uint, (@sizeOf([46]OnigPairCaseFoldCodes) / @sizeOf(OnigPairCaseFoldCodes)))), &CaseFoldMap, @as(c_int, 0), flag, f, arg);
}
pub fn get_case_fold_codes_by_str(arg_flag: OnigCaseFoldType, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_items: [*c]OnigCaseFoldCodeItem) callconv(.C) c_int {
    ...
    var end = arg_end;
    var items = arg_items;
    return onigenc_get_case_fold_codes_by_str_with_map(@bitCast(c_int, @truncate(c_uint, (@sizeOf([46]OnigPairCaseFoldCodes) / @sizeOf(OnigPairCaseFoldCodes)))), &CaseFoldMap, @as(c_int, 0), flag, p, end, items);
}
...
pub fn ENC_ISO_8859_5_TO_LOWER_CASE(c: anytype) callconv(.Inline) @TypeOf(EncISO_8859_5_ToLowerCaseTable[c]) {
    return EncISO_8859_5_ToLowerCaseTable[c];
}
pub fn ENC_IS_ISO_8859_5_CTYPE(code: anytype, ctype: anytype) callconv(.Inline) @TypeOf((EncISO_8859_5_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0) {
    return (EncISO_8859_5_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0;
}
