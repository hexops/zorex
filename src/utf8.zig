...
pub const EncLen_UTF8: [256]c_int = [256]c_int{
    @as(c_int, 1),
    @as(c_int, 1),
    @as(c_int, 1),
    @as(c_int, 1),
...
pub fn is_valid_mbc_string(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    ...
    while (p < end) {
        if (!(@bitCast(c_int, @as(c_uint, @bitCast(OnigUChar, @truncate(i8, (@bitCast(c_int, @as(c_uint, (p.?.*))) & @as(c_int, 192)))))) != @as(c_int, 128))) return 0;
        len = mbc_enc_len((blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
        ...
        if (len > @as(c_int, 1)) {
            {
                ...
                while (i < len) : (i += 1) {
                    if (p == end) return 0;
                    if (!(@bitCast(c_int, @as(c_uint, @bitCast(OnigUChar, @truncate(i8, (@bitCast(c_int, @as(c_uint, ((blk: {
                        const ref = &p;
                        const tmp = ref.*;
                        ref.* += 1;
                        break :blk tmp;
                    }).?.*))) & @as(c_int, 192)))))) == @as(c_int, 128))) return 0;
                }
            }
        }
    }
...
pub fn mbc_to_code(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) OnigCodePoint {
    ...
    len = mbc_enc_len(p);
    if (len > @bitCast(c_int, @truncate(c_int, (end - p)))) len = @bitCast(c_int, @truncate(c_int, (end - p)));
    ...
    if (len > @as(c_int, 1)) {
        len -= 1;
        n = @bitCast(OnigCodePoint, (c & ((@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (@as(c_int, 6) - len))) - @as(c_int, 1))));
        while ((blk: {
            const ref = &len;
            const tmp = ref.*;
            ref.* -= 1;
            ...
            n = ((n << @intCast(@import("std").math.Log2Int(OnigCodePoint), 6)) | @bitCast(c_uint, (c & ((@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), 6)) - @as(c_int, 1)))));
        }
        return n;
    } else {
        return @bitCast(OnigCodePoint, c);
    }
    return 0;
}
pub fn code_to_mbclen(arg_code: OnigCodePoint) callconv(.C) c_int {
    var code = arg_code;
    if ((code & @as(c_uint, 4294967168)) == @bitCast(c_uint, @as(c_int, 0))) return 1 else if ((code & @as(c_uint, 4294965248)) == @bitCast(c_uint, @as(c_int, 0))) return 2 else if ((code & @as(c_uint, 4294901760)) == @bitCast(c_uint, @as(c_int, 0))) return 3 else if ((code & @as(c_uint, 4292870144)) == @bitCast(c_uint, @as(c_int, 0))) return 4 else return -@as(c_int, 400);
    return 0;
}
pub fn code_to_mbc(arg_code: OnigCodePoint, arg_buf: [*c]OnigUChar) callconv(.C) c_int {
    var code = arg_code;
    var buf = arg_buf;
    if ((code & @as(c_uint, 4294967168)) == @bitCast(c_uint, @as(c_int, 0))) {
        buf.?.* = @bitCast(OnigUChar, @truncate(u8, code));
        return 1;
    } else {
        var p: [*c]OnigUChar = buf;
        if ((code & @as(c_uint, 4294965248)) == @bitCast(c_uint, @as(c_int, 0))) {
            (blk: {
                const ref = &p;
                const tmp = ref.*;
                ref.* += 1;
                break :blk tmp;
            }).?.* = @bitCast(OnigUChar, @truncate(u8, (((code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 6)) & @bitCast(c_uint, @as(c_int, 31))) | @bitCast(c_uint, @as(c_int, 192)))));
        } else if ((code & @as(c_uint, 4294901760)) == @bitCast(c_uint, @as(c_int, 0))) {
            (blk: {
                const ref = &p;
                const tmp = ref.*;
                ref.* += 1;
                break :blk tmp;
            }).?.* = @bitCast(OnigUChar, @truncate(u8, (((code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 12)) & @bitCast(c_uint, @as(c_int, 15))) | @bitCast(c_uint, @as(c_int, 224)))));
            (blk: {
                const ref = &p;
                const tmp = ref.*;
                ref.* += 1;
                break :blk tmp;
            }).?.* = @bitCast(OnigUChar, @truncate(u8, ((((code) >> @intCast(@import("std").math.Log2Int(OnigCodePoint), (@as(c_int, 6)))) & @bitCast(c_uint, @as(c_int, 63))) | @bitCast(c_uint, @as(c_int, 128)))));
        } else if ((code & @as(c_uint, 4292870144)) == @bitCast(c_uint, @as(c_int, 0))) {
            (blk: {
                const ref = &p;
                const tmp = ref.*;
                ref.* += 1;
                break :blk tmp;
            }).?.* = @bitCast(OnigUChar, @truncate(u8, (((code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 18)) & @bitCast(c_uint, @as(c_int, 7))) | @bitCast(c_uint, @as(c_int, 240)))));
            (blk: {
                const ref = &p;
                const tmp = ref.*;
                ref.* += 1;
                break :blk tmp;
            }).?.* = @bitCast(OnigUChar, @truncate(u8, ((((code) >> @intCast(@import("std").math.Log2Int(OnigCodePoint), (@as(c_int, 12)))) & @bitCast(c_uint, @as(c_int, 63))) | @bitCast(c_uint, @as(c_int, 128)))));
            (blk: {
                const ref = &p;
                const tmp = ref.*;
                ref.* += 1;
        ...
        (blk: {
            ...
            ref.* += 1;
            break :blk tmp;
        }).?.* = @bitCast(OnigUChar, @truncate(u8, (((code) & @bitCast(c_uint, @as(c_int, 63))) | @bitCast(c_uint, @as(c_int, 128)))));
        return @bitCast(c_int, @truncate(c_int, (p - buf)));
    }
    return 0;
}
pub fn mbc_case_fold(arg_flag: OnigCaseFoldType, arg_pp: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_fold: [*c]OnigUChar) callconv(.C) c_int {
    var flag = arg_flag;
    var pp = arg_pp;
    var end = arg_end;
    var fold = arg_fold;
    ...
    if (@bitCast(c_int, @as(c_uint, (p).?.*)) < @as(c_int, 128)) {
        ...
        return onigenc_unicode_mbc_case_fold((&OnigEncodingUTF8), flag, pp, end, fold);
    }
    return 0;
}
...
pub fn left_adjust_char_head(arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    ...
    p = s;
    while (!(@bitCast(c_int, @as(c_uint, @bitCast(OnigUChar, @truncate(i8, (@bitCast(c_int, @as(c_uint, (p.?.*))) & @as(c_int, 192)))))) != @as(c_int, 128)) and (p > start)) p -= 1;
    return @intToPtr([*c]OnigUChar, @ptrToInt(p));
}
pub fn get_case_fold_codes_by_str(arg_flag: OnigCaseFoldType, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_items: [*c]OnigCaseFoldCodeItem) callconv(.C) c_int {
    ...
    var end = arg_end;
    var items = arg_items;
    return onigenc_unicode_get_case_fold_codes_by_str((&OnigEncodingUTF8), flag, p, end, items);
}
...
pub fn utf8_islead(c: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(UChar, c & 0xc0)) != 0x80) {
    return (@import("std").meta.cast(UChar, c & 0xc0)) != 0x80;
}
pub fn utf8_istail(c: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(UChar, c & 0xc0)) == 0x80) {
    return (@import("std").meta.cast(UChar, c & 0xc0)) == 0x80;
}
pub fn UTF8_TRAILS(code: anytype, shift: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(UChar, ((code >> shift) & 0x3f) | 0x80))) {
    return (@import("std").meta.cast(UChar, ((code >> shift) & 0x3f) | 0x80));
}
pub fn UTF8_TRAIL0(code: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(UChar, (code & 0x3f) | 0x80))) {
    return (@import("std").meta.cast(UChar, (code & 0x3f) | 0x80));
}
