...
const wordlist: [14]c_short = [14]c_short{
    @bitCast(c_short, @truncate(c_short, @as(c_int, 62))),
    @bitCast(c_short, @truncate(c_short, @as(c_int, 47))),
    @bitCast(c_short, @truncate(c_short, @as(c_int, 31))),
    @bitCast(c_short, @truncate(c_short, @as(c_int, 57))),
    @bitCast(c_short, @truncate(c_short, @as(c_int, 41))),
...
pub export fn onigenc_unicode_fold3_key(arg_codes: [*c]OnigCodePoint) c_int {
    var codes = arg_codes;
    _ = wordlist;
    {
        ...
        if (key <= @as(c_int, 13)) {
            ...
            if ((index_1 >= @as(c_int, 0)) and (onig_codes_cmp(codes, (&OnigUnicodeFolds3 + index_1), @as(c_int, 3)) == @as(c_int, 0))) return index_1;
        }
    }
    return -@as(c_int, 1);
}
...
pub fn hash(arg_codes: [*c]OnigCodePoint) callconv(.C) c_uint {
    var codes = arg_codes;
    _ = asso_values;
    return @bitCast(c_uint, ((@bitCast(c_int, @as(c_uint, asso_values[@bitCast(u8, @truncate(i8, onig_codes_byte_at(codes, @as(c_int, 8))))])) + @bitCast(c_int, @as(c_uint, asso_values[@bitCast(u8, @truncate(i8, onig_codes_byte_at(codes, @as(c_int, 5))))]))) + @bitCast(c_int, @as(c_uint, asso_values[@bitCast(u8, @truncate(i8, onig_codes_byte_at(codes, @as(c_int, 2))))]))));
}
...
pub const TOTAL_KEYWORDS = 14;
pub const MIN_WORD_LENGTH = 9;
pub const MAX_WORD_LENGTH = 9;
pub const MIN_HASH_VALUE = 0;
pub const MAX_HASH_VALUE = 13;
