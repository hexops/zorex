...
pub extern fn onig_init() c_int; // ./src/todo/regerror.c:291:1: warning: TODO unable to translate variadic function, demoted to declaration
pub extern fn onig_error_code_to_str(s: [*c]OnigUChar, code: c_int, ...) c_int; // ./src/todo/regerror.c:277:3: warning: TODO complex switch cases
pub const onig_is_error_code_needs_param = @compileError("unable to translate function"); // ./src/todo/regerror.c:271:1
...
} // ./src/todo/regerror.c:352:1: warning: TODO unable to translate variadic function, demoted to declaration
