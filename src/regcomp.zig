...
const Operation = @import("regint.zig").Operation;
const RePatternBuffer = @import("regint.zig").RePatternBuffer;
...
const Node = @import("regparse_header.zig").Node;
const NodeBase = @import("regparse_header.zig").NodeBase;
const NodeType = @import("regparse_header.zig").NodeType;
...
pub fn reduceStringList(node: *Node) !isize {
    // TODO(slimsag): r is success value, change to error type
    var r: isize = 0;
