...
pub fn onig_match(arg_reg: OnigRegex, arg_str: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_at: [*c]const OnigUChar, arg_region: [*c]OnigRegion, arg_option: OnigOptionType) callconv(.C) c_int {
    ...
    onig_free_match_param_content(&mp);
    return r;
} // ./src/todo/regexec.c:5090:9: warning: TODO implement translation of stmt class GotoStmtClass
pub const onig_match_with_param = @compileError("unable to translate function"); // ./src/todo/regexec.c:5063:1
...
pub fn onig_regset_search(arg_set: [*c]OnigRegSet, arg_str: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_start: [*c]const OnigUChar, arg_range: [*c]const OnigUChar, arg_lead: OnigRegSetLead, arg_option: OnigOptionType, arg_rmatch_pos: [*c]c_int) callconv(.C) c_int {
    ...
    return r;
} // ./src/todo/regexec.c:4656:19: warning: TODO implement translation of stmt class GotoStmtClass
pub const onig_regset_search_with_param = @compileError("unable to translate function"); // ./src/todo/regexec.c:4624:1
...
pub const forward_search = @compileError("unable to translate function"); // ./src/todo/regexec.c:5110:1
// ./src/todo/regexec.c:5377:5: warning: TODO implement translation of stmt class GotoStmtClass
pub const search_in_range = @compileError("unable to translate function"); // ./src/todo/regexec.c:5355:1
...
const struct_unnamed_74 = extern struct {
    ...
    slot: [5]struct_unnamed_75,
};
pub const CalloutData = struct_unnamed_74;
...
pub const MatchArg = struct_unnamed_76;
...
pub const StkPtrType = union_unnamed_77;
...
const union_unnamed_78 = extern union {
    state: struct_unnamed_79,
    repeat_inc: struct_unnamed_80,
    mem: struct_unnamed_81,
    empty_check: struct_unnamed_82,
    call_frame: struct_unnamed_83,
    val: struct_unnamed_84,
    callout: struct_unnamed_85,
};
...
pub const posix_regmatch_t = struct_unnamed_86;
= extern struct { state:
    c_int,
,low
, high : [ *c]OnigUChar,
pub const match_at = @compileError("unable to translate function"); // ./src/todo/regexec.c:2787:1
const struct_unnamed_87 = extern struct {
    reg: [*c]regex_t,
    region: [*c]OnigRegion,
};
pub const RR = struct_unnamed_87;
...
pub const SearchRange = struct_unnamed_88;
pub const regset_search_body_position_lead = @compileError("unable to translate function"); // ./src/todo/regexec.c:4432:1
...
pub fn map_search_backward(arg_enc: OnigEncoding, arg_map: [*c]OnigUChar, arg_text: [*c]const OnigUChar, arg_adjust_text: [*c]const OnigUChar, arg_text_start: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    ...
    return @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (@intToPtr(?*c_void, @as(c_int, 0)))));
} // ./src/todo/regexec.c:5238:2: warning: TODO implement translation of stmt class LabelStmtClass
pub const backward_search = @compileError("unable to translate function"); // ./src/todo/regexec.c:5231:1
...
pub const CALLOUT_BODY = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1023:9
pub const RETRACTION_CALLOUT = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1042:9
pub const UPDATE_FOR_STACK_REALLOC = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1204:9
pub const SAVE_REPEAT_STK_VAR = @compileError("unable to translate C expr: unexpected token .Nl"); // ./src/todo/regexec.c:1209:9
pub const LOAD_TO_REPEAT_STK_VAR = @compileError("unable to translate C expr: unexpected token .Nl"); // ./src/todo/regexec.c:1210:9
pub const SAVE_EMPTY_CHECK_STK_VAR = @compileError("unable to translate C expr: unexpected token .Nl"); // ./src/todo/regexec.c:1213:9
pub const LOAD_TO_EMPTY_CHECK_STK_VAR = @compileError("unable to translate C expr: unexpected token .Nl"); // ./src/todo/regexec.c:1214:9
pub const RETRY_IN_MATCH_ARG_INIT = @compileError("unable to translate C expr: unexpected token .Equal"); // ./src/todo/regexec.c:1220:9
pub const SUBEXP_CALL_IN_MATCH_ARG_INIT = @compileError("unable to translate C expr: unexpected token .Equal"); // ./src/todo/regexec.c:1229:9
pub const POP_CALL = @compileError("unable to translate C expr: unexpected token .Keyword_else"); // ./src/todo/regexec.c:1232:9
pub const MATCH_ARG_INIT = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1239:9
pub const MATCH_ARG_FREE = @compileError("unable to translate C expr: unexpected token .Keyword_if"); // ./src/todo/regexec.c:1265:9
pub const STACK_INIT = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1270:9
pub const STACK_SAVE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1302:9
pub const CHECK_RETRY_LIMIT_IN_MATCH = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1336:9
pub const ADJUST_MATCH_PARAM = @compileError("unable to translate C expr: unexpected token .Equal"); // ./src/todo/regexec.c:1495:9
pub const STACK_ENSURE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1710:9
pub const STACK_PUSH_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1721:9
pub const STACK_PUSH = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1729:9
pub const STACK_PUSH_WITH_ZID = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1737:9
pub const STACK_PUSH_ENSURED = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1746:9
pub const STACK_PUSH_BOTTOM = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1760:9
pub const STACK_PUSH_REPEAT_INC = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1781:9
pub const STACK_PUSH_MEM_START = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1791:9
pub const STACK_PUSH_MEM_END = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1803:9
pub const STACK_PUSH_MEM_END_MARK = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1814:9
pub const STACK_GET_MEM_START = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1821:9
pub const STACK_GET_MEM_RANGE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1837:9
pub const STACK_PUSH_EMPTY_CHECK_START = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1855:9
pub const STACK_PUSH_EMPTY_CHECK_END = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1865:9
pub const STACK_PUSH_CALL_FRAME = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1872:9
pub const STACK_PUSH_RETURN = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1879:9
pub const STACK_PUSH_MARK = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1885:9
pub const STACK_PUSH_MARK_WITH_POS = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1892:9
pub const STACK_PUSH_SAVE_VAL = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1900:9
pub const STACK_PUSH_SAVE_VAL_WITH_SPREV = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1909:9
pub const STACK_GET_SAVE_VAL_TYPE_LAST = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1918:9
pub const STACK_GET_SAVE_VAL_TYPE_LAST_ID = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1930:9
pub const STACK_GET_SAVE_VAL_TYPE_LAST_ID_WITH_SPREV = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1951:9
pub const STACK_PUSH_CALLOUT_CONTENTS = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1971:9
pub const STACK_PUSH_CALLOUT_NAME = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1980:9
pub const STACK_BASE_CHECK = @compileError("unable to translate C expr: unexpected token .Nl"); // ./src/todo/regexec.c:1996:9
pub const STACK_POP_ONE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:1999:9
pub const POP_CALLOUT_CASE = @compileError("unable to translate C expr: unexpected token .Keyword_else"); // ./src/todo/regexec.c:2006:9
pub const STACK_POP = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2014:9
pub const STACK_POP_TO_MARK = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2058:9
pub const POP_TIL_BODY = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2085:9
pub const STACK_TO_VOID_TO_MARK = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2110:9
pub const EMPTY_CHECK_START_SEARCH = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2128:9
pub const STACK_EMPTY_CHECK = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2156:9
pub const STACK_MEM_START_GET_PREV_END_ADDR = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2162:9
pub const STACK_EMPTY_CHECK_MEM = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2175:9
pub const STACK_EMPTY_CHECK_MEM_REC = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2210:9
pub const STACK_GET_REPEAT_COUNT_SEARCH = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2303:9
pub const STACK_RETURN = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2343:9
pub const GET_STACK_RETURN_CALL = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2361:9
pub const STRING_CMP = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2381:9
pub const STRING_CMP_IC = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2387:9
pub const STRING_CMP_VALUE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2424:9
pub const STRING_CMP_VALUE_IC = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2433:9
pub const DATA_ENSURE = @compileError("unable to translate C expr: unexpected token .Keyword_if"); // ./src/todo/regexec.c:2446:9
pub const INIT_RIGHT_RANGE = @compileError("unable to translate C expr: unexpected token .Equal"); // ./src/todo/regexec.c:2448:9
pub const STACK_INC = @compileError("TODO postfix inc/dec expr"); // ./src/todo/regexec.c:2667:9
pub const SOP_IN = @compileError("unable to translate C expr: unexpected token .Nl"); // ./src/todo/regexec.c:2669:9
pub const BYTECODE_INTERPRETER_START = @compileError("unable to translate C expr: unexpected token .Semicolon"); // ./src/todo/regexec.c:2686:9
pub const CASE_OP = @compileError("unable to translate C expr: unexpected token .HashHash"); // ./src/todo/regexec.c:2688:9
pub const GOTO_OP = @compileError("unable to translate C expr: unexpected token .Keyword_goto"); // ./src/todo/regexec.c:2693:9
pub const INC_OP = @compileError("TODO postfix inc/dec expr"); // ./src/todo/regexec.c:2715:9
pub const JUMP_OUT_WITH_SPREV_SET = @compileError("unable to translate C expr: unexpected token .Semicolon"); // ./src/todo/regexec.c:2716:9
pub const JUMP_OUT = @compileError("unable to translate C expr: unexpected token .Semicolon"); // ./src/todo/regexec.c:2717:9
pub const BREAK_OUT = @compileError("unable to translate C expr: unexpected token .Semicolon"); // ./src/todo/regexec.c:2718:9
pub const CHECK_INTERRUPT_JUMP_OUT = @compileError("unable to translate C expr: unexpected token .Semicolon"); // ./src/todo/regexec.c:2719:9
pub const MATCH_DEBUG_OUT = @compileError("unable to translate C expr: unexpected token .Nl"); // ./src/todo/regexec.c:2766:9
pub const MATCH_AT_ERROR_RETURN = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2769:9
pub const MATCH_COUNTER_OUT = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regexec.c:2773:9
pub const REGSET_MATCH_AND_RETURN_CHECK = @compileError("unable to translate C expr: unexpected token .Equal"); // ./src/todo/regexec.c:4422:9
pub const MATCH_AND_RETURN_CHECK = @compileError("unable to translate C expr: unexpected token .Equal"); // ./src/todo/regexec.c:5400:9
