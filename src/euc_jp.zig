...
pub const EncLen_EUCJP: [256]c_int = [256]c_int{
    @as(c_int, 1),
    @as(c_int, 1),
    @as(c_int, 1),
    @as(c_int, 1),
...
pub fn mbc_enc_len(arg_p: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
...
pub fn is_valid_mbc_string(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    ...
    while (p < end) {
        if (@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 128)) {
            p += 1;
        } else if (@bitCast(c_int, @as(c_uint, p.?.*)) > @as(c_int, 160)) {
            if (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 255)) return 0;
            p += 1;
            if (p >= end) return 0;
            if ((@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 161)) or (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 255))) return 0;
            p += 1;
        } else if (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 142)) {
            p += 1;
            if (p >= end) return 0;
            if ((@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 161)) or (@bitCast(c_int, @as(c_uint, p.?.*)) > @as(c_int, 223))) return 0;
            p += 1;
        } else if (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 143)) {
            p += 1;
            if (p >= end) return 0;
            if ((@bitCast(c_int, @as(c_uint, p.?.*)) < @as(c_int, 161)) or (@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 255))) return 0;
            p += 1;
...
pub fn mbc_to_code(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) OnigCodePoint {
    var p = arg_p;
    var end = arg_end;
    ...
    len = (&OnigEncodingEUC_JP).*.mbc_enc_len.?(p);
...
pub fn code_to_mbclen(arg_code: OnigCodePoint) callconv(.C) c_int {
    var code = arg_code;
    if ((code) < @bitCast(c_uint, @as(c_int, 128))) return 1 else if ((code & @bitCast(c_uint, @as(c_int, 16711680))) != @bitCast(c_uint, @as(c_int, 0))) {
        if (EncLen_EUCJP[@intCast(c_uint, (@bitCast(c_int, (code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 16))) & @as(c_int, 255)))] == @as(c_int, 3)) return 3;
    } else if ((code & @bitCast(c_uint, @as(c_int, 65280))) != @bitCast(c_uint, @as(c_int, 0))) {
        if (EncLen_EUCJP[@intCast(c_uint, (@bitCast(c_int, (code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 8))) & @as(c_int, 255)))] == @as(c_int, 2)) return 2;
    } else if (code < @bitCast(c_uint, @as(c_int, 256))) {
        if (EncLen_EUCJP[@intCast(c_uint, @bitCast(c_int, (code & @bitCast(c_uint, @as(c_int, 255)))))] == @as(c_int, 1)) return 1;
    }
    return -@as(c_int, 400);
}
pub fn code_to_mbc(arg_code: OnigCodePoint, arg_buf: [*c]OnigUChar) callconv(.C) c_int {
    var code = arg_code;
    var buf = arg_buf;
    var p: [*c]OnigUChar = buf;
    if ((code & @bitCast(c_uint, @as(c_int, 16711680))) != @bitCast(c_uint, @as(c_int, 0))) {
        (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
    ...
    } else if ((code & @bitCast(c_uint, @as(c_int, 65280))) != @bitCast(c_uint, @as(c_int, 0))) (blk: {
        const ref = &p;
        const tmp = ref.*;
        ref.* += 1;
        break :blk tmp;
    ...
    if (@bitCast(c_long, @as(c_long, (&OnigEncodingEUC_JP).*.mbc_enc_len.?(buf))) != (p - buf)) return -@as(c_int, 400);
...
pub fn left_adjust_char_head(arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var start = arg_start;
    var s = arg_s;
    ...
    p = s;
    while (!(@bitCast(c_int, @as(c_uint, @bitCast(OnigUChar, @truncate(i8, (@bitCast(c_int, @as(c_uint, (p.?.*))) - @as(c_int, 161)))))) > (@as(c_int, 254) - @as(c_int, 161))) and (p > start)) p -= 1;
    len = (&OnigEncodingEUC_JP).*.mbc_enc_len.?(p);
    if ((p + len) > s) return @intToPtr([*c]OnigUChar, @ptrToInt(p));
    p += len;
    return @intToPtr([*c]OnigUChar, @ptrToInt((p + ((s - p) & @bitCast(c_long, @as(c_long, ~@as(c_int, 1)))))));
}
pub fn is_allowed_reverse_match(arg_s: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var s = arg_s;
    var end = arg_end;
    const c: OnigUChar = s.?.*;
    if (((@bitCast(c_int, @as(c_uint, c)) <= @as(c_int, 126)) or (@bitCast(c_int, @as(c_uint, c)) == @as(c_int, 142))) or (@bitCast(c_int, @as(c_uint, c)) == @as(c_int, 143))) return 1 else return 0;
    return 0;
}
pub const CR_Hiragana: [3]OnigCodePoint = [3]OnigCodePoint{
    @bitCast(OnigCodePoint, @as(c_int, 1)),
    @bitCast(OnigCodePoint, @as(c_int, 42145)),
    @bitCast(OnigCodePoint, @as(c_int, 42227)),
};
pub const CR_Katakana: [7]OnigCodePoint = [7]OnigCodePoint{
    @bitCast(OnigCodePoint, @as(c_int, 3)),
    @bitCast(OnigCodePoint, @as(c_int, 42401)),
    @bitCast(OnigCodePoint, @as(c_int, 42486)),
    @bitCast(OnigCodePoint, @as(c_int, 43686)),
    @bitCast(OnigCodePoint, @as(c_int, 43695)),
    @bitCast(OnigCodePoint, @as(c_int, 43697)),
    @bitCast(OnigCodePoint, @as(c_int, 43741)),
};
pub var PropertyList: [2][*c]const OnigCodePoint = [2][*c]const OnigCodePoint{
    &CR_Hiragana,
    &CR_Katakana,
};
pub fn property_name_to_ctype(arg_enc: OnigEncoding, arg_p: [*c]OnigUChar, arg_end: [*c]OnigUChar) callconv(.C) c_int {
    var enc = arg_enc;
    var p = arg_p;
    var end = arg_end;
    var pc: [*c]struct_PropertyNameCtype = undefined;
    var len: c_int = @bitCast(c_int, @truncate(c_int, (end - p)));
    var q: [32]u8 = undefined;
    if (@bitCast(c_ulong, @as(c_long, len)) < (@sizeOf([32]u8) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))) {
        _ = __builtin___memcpy_chk(@ptrCast(?*c_void, &q), @ptrCast(?*const c_void, p), @bitCast(usize, @as(c_long, len)), __builtin_object_size(@ptrCast(?*const c_void, &q), @as(c_int, 0)));
        q[@intCast(c_uint, len)] = @bitCast(u8, @truncate(i8, @as(c_int, '\x00')));
        pc = onigenc_euc_jp_lookup_property_name(&q, @bitCast(usize, @as(c_long, len)));
        if (pc != null) return pc.*.ctype;
    }
    return -@as(c_int, 223);
}
pub fn is_code_ctype(arg_code: OnigCodePoint, arg_ctype: c_uint) callconv(.C) c_int {
    var code = arg_code;
    var ctype = arg_ctype;
    if (ctype <= @bitCast(c_uint, ONIGENC_CTYPE_ASCII)) {
        if (code < @bitCast(c_uint, @as(c_int, 128))) return @boolToInt(((@bitCast(c_int, @as(c_uint, OnigEncAsciiCtypeTable[code])) & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (ctype)))) != @as(c_int, 0))) else {
            if ((((ctype) == @bitCast(c_uint, ONIGENC_CTYPE_WORD)) or ((ctype) == @bitCast(c_uint, ONIGENC_CTYPE_GRAPH))) or ((ctype) == @bitCast(c_uint, ONIGENC_CTYPE_PRINT))) {
                return (if (code_to_mbclen(code) > @as(c_int, 1)) @as(c_int, 1) else @as(c_int, 0));
            }
        }
    } else {
        ctype -%= @bitCast(c_uint, (ONIGENC_CTYPE_ASCII + @as(c_int, 1)));
        if (ctype >= @bitCast(c_uint, @truncate(c_uint, (@sizeOf([2][*c]const OnigCodePoint) / @sizeOf([*c]const OnigCodePoint))))) return -@as(c_int, 6);
        return onig_is_in_code_range(@intToPtr([*c]OnigUChar, @ptrToInt(PropertyList[ctype])), code);
    }
    return 0;
}
pub fn get_ctype_code_range(arg_ctype: OnigCtype, arg_sb_out: [*c]OnigCodePoint, arg_ranges: [*c][*c]const OnigCodePoint) callconv(.C) c_int {
    var ctype = arg_ctype;
    ...
    if (ctype <= @bitCast(c_uint, ONIGENC_CTYPE_ASCII)) {
        ...
        sb_out.?.* = @bitCast(OnigCodePoint, @as(c_int, 128));
        ctype -%= @bitCast(c_uint, (ONIGENC_CTYPE_ASCII + @as(c_int, 1)));
        if (@bitCast(c_ulong, @as(c_ulong, ctype)) >= (@bitCast(c_ulong, @as(c_ulong, @bitCast(OnigCtype, @truncate(c_uint, @sizeOf([2][*c]const OnigCodePoint))))) / @sizeOf([*c]const OnigCodePoint))) return -@as(c_int, 6);
...
pub fn eucjp_islead(c: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(UChar, c - 0xa1)) > (0xfe - 0xa1)) {
    return (@import("std").meta.cast(UChar, c - 0xa1)) > (0xfe - 0xa1);
}
