...
pub const EncISO_8859_8_CtypeTable: [256]c_ushort = [256]c_ushort{
    ...
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 0))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 416))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12450))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12450))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12450))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12450))),
    @bitCast(c_ushort, @truncate(c_short, @as(c_int, 12450))),
...
pub fn is_code_ctype(arg_code: OnigCodePoint, arg_ctype: c_uint) callconv(.C) c_int {
    var code = arg_code;
    var ctype = arg_ctype;
    if (code < @bitCast(c_uint, @as(c_int, 256))) return @boolToInt(((@bitCast(c_int, @as(c_uint, EncISO_8859_8_CtypeTable[code])) & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), (ctype)))) != @as(c_int, 0))) else return 0;
    return 0;
}
...
pub fn ENC_IS_ISO_8859_8_CTYPE(code: anytype, ctype: anytype) callconv(.Inline) @TypeOf((EncISO_8859_8_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0) {
    return (EncISO_8859_8_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0;
}
