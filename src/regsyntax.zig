...
pub fn onig_set_default_syntax(arg_syntax: [*c]OnigSyntaxType) callconv(.C) c_int {
    var syntax = arg_syntax;
    if ((@ptrCast(?*c_void, (syntax))) == @intToPtr(?*c_void, @as(c_int, 0))) syntax = (&OnigSyntaxOniguruma);
    OnigDefaultSyntax = syntax;
    return 0;
}
pub fn onig_copy_syntax(arg_to: [*c]OnigSyntaxType, arg_from: [*c]OnigSyntaxType) callconv(.C) void {
    var to = arg_to;
    var from = arg_from;
    to.?.* = from.?.*;
}
pub fn onig_get_syntax_op(arg_syntax: [*c]OnigSyntaxType) callconv(.C) c_uint {
    var syntax = arg_syntax;
    return syntax.*.op;
}
pub fn onig_get_syntax_op2(arg_syntax: [*c]OnigSyntaxType) callconv(.C) c_uint {
    var syntax = arg_syntax;
    return syntax.*.op2;
}
pub fn onig_get_syntax_behavior(arg_syntax: [*c]OnigSyntaxType) callconv(.C) c_uint {
    var syntax = arg_syntax;
    return syntax.*.behavior;
}
pub fn onig_get_syntax_options(arg_syntax: [*c]OnigSyntaxType) callconv(.C) OnigOptionType {
    var syntax = arg_syntax;
    return syntax.*.options;
}
pub fn onig_set_syntax_op(arg_syntax: [*c]OnigSyntaxType, arg_op: c_uint) callconv(.C) void {
    var syntax = arg_syntax;
    var op = arg_op;
    syntax.*.op = op;
}
pub fn onig_set_syntax_op2(arg_syntax: [*c]OnigSyntaxType, arg_op2: c_uint) callconv(.C) void {
    var syntax = arg_syntax;
    var op2 = arg_op2;
    syntax.*.op2 = op2;
}
pub fn onig_set_syntax_behavior(arg_syntax: [*c]OnigSyntaxType, arg_behavior: c_uint) callconv(.C) void {
    var syntax = arg_syntax;
    var behavior = arg_behavior;
    syntax.*.behavior = behavior;
}
pub fn onig_set_syntax_options(arg_syntax: [*c]OnigSyntaxType, arg_options: OnigOptionType) callconv(.C) void {
    var syntax = arg_syntax;
    var options = arg_options;
    syntax.*.options = options;
}
pub fn onig_set_meta_char(arg_enc: [*c]OnigSyntaxType, arg_what: c_uint, arg_code: OnigCodePoint) callconv(.C) c_int {
    var enc = arg_enc;
    var what = arg_what;
    var code = arg_code;
    switch_11: {
