...
pub extern fn onig_new_without_alloc(OnigRegex, pattern: [*c]const OnigUChar, pattern_end: [*c]const OnigUChar, option: OnigOptionType, enc: OnigEncoding, syntax: [*c]OnigSyntaxType, einfo: [*c]OnigErrorInfo) c_int; // ../oniguruma/src/regext.c:184:5: warning: TODO implement translation of stmt class GotoStmtClass
pub const onig_new_deluxe = @compileError("unable to translate function"); // ../oniguruma/src/regext.c:165:1
