...
pub const onig_regex_t = OnigRegexType;
...
pub extern fn onig_regset_new(rset: [*c]?*OnigRegSet, n: c_int, regs: [*c][*c]onig_regex_t) c_int;
pub extern fn onig_regset_add(set: ?*OnigRegSet, reg: [*c]onig_regex_t) c_int;
pub extern fn onig_regset_replace(set: ?*OnigRegSet, at: c_int, reg: [*c]onig_regex_t) c_int;
pub extern fn onig_regset_free(set: ?*OnigRegSet) void;
pub extern fn onig_regset_number_of_regex(set: ?*OnigRegSet) c_int;
pub extern fn onig_regset_get_regex(set: ?*OnigRegSet, at: c_int) [*c]onig_regex_t;
...
pub extern fn onig_compile(reg: [*c]onig_regex_t, pattern: [*c]const OnigUChar, pattern_end: [*c]const OnigUChar, einfo: [*c]OnigErrorInfo) c_int;
pub extern fn onig_is_code_in_cc_len(enclen: c_int, code: OnigCodePoint, cc: ?*c_void) c_int;
pub extern fn onig_get_regex_ext(reg: [*c]onig_regex_t) [*c]RegexExt;
pub extern fn onig_ext_set_pattern(reg: [*c]onig_regex_t, pattern: [*c]const OnigUChar, pattern_end: [*c]const OnigUChar) c_int;
...
pub extern fn onig_reg_callout_list_at(reg: [*c]onig_regex_t, num: c_int) [*c]CalloutListEntry;
pub extern fn onig_get_callout_start_func(reg: [*c]onig_regex_t, callout_num: c_int) OnigCalloutFunc;
...
pub const onig_posix_regmatch_t = struct_unnamed_75;
const struct_unnamed_76 = extern struct {
    onig: ?*c_void,
    re_nsub: usize,
    comp_options: c_int,
};
pub const onig_posix_regex_t = struct_unnamed_76;
pub fn onig_posix_regcomp(arg_reg: [*c]onig_posix_regex_t, arg_pattern: [*c]const u8, arg_posix_options: c_int) callconv(.C) c_int {
    var reg = arg_reg;
    var pattern = arg_pattern;
    var posix_options = arg_posix_options;
    var r: c_int = undefined;
    var len: c_int = undefined;
    var syntax: [*c]OnigSyntaxType = OnigDefaultSyntax;
    var options: OnigOptionType = undefined;
    reg.*.onig = @intToPtr(?*c_void, @as(c_int, 0));
    if ((posix_options & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), 4))) == @as(c_int, 0)) syntax = (&OnigSyntaxPosixBasic);
    options = syntax.*.options;
    if ((posix_options & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), 0))) != @as(c_int, 0)) _ = (blk: {
        const ref = &(options);
        ref.* = ref.* | (@as(c_uint, 1));
        break :blk ref.*;
    });
    if ((posix_options & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), 1))) != @as(c_int, 0)) {
        _ = (blk: {
            const ref = &(options);
            ref.* = ref.* | ((((((@as(c_uint, 1) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1));
            break :blk ref.*;
        });
        _ = (blk: {
            const ref = &(options);
            ref.* = ref.* & ~(((@as(c_uint, 1) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1));
            break :blk ref.*;
        });
    }
    reg.*.comp_options = posix_options;
    while (true) {
        if (((OnigEncDefaultCharEncoding).*.min_enc_len) == @as(c_int, 1)) {
            var tmps: [*c]OnigUChar = @intToPtr([*c]OnigUChar, @ptrToInt((pattern)));
            while (@bitCast(c_int, @as(c_uint, tmps.?.*)) != @as(c_int, 0)) tmps += 1;
            len = @bitCast(c_int, @truncate(c_int, (tmps - @intToPtr([*c]OnigUChar, @ptrToInt((pattern))))));
        } else {
            len = onigenc_str_bytelen_null(OnigEncDefaultCharEncoding, @intToPtr([*c]OnigUChar, @ptrToInt(pattern)));
        }
        if (!false) break;
    }
    r = onig_new((@ptrCast([*c][*c]onig_regex_t, @alignCast(@alignOf([*c]onig_regex_t), (&(reg).*.onig)))), @intToPtr([*c]OnigUChar, @ptrToInt(pattern)), @intToPtr([*c]OnigUChar, @ptrToInt((pattern + len))), options, OnigEncDefaultCharEncoding, syntax, @ptrCast([*c]OnigErrorInfo, @alignCast(@alignOf(OnigErrorInfo), (@intToPtr(?*c_void, @as(c_int, 0))))));
    if (r != @as(c_int, 0)) {
        return onig2posix_error_code(r);
    }
    reg.*.re_nsub = @bitCast(usize, @as(c_long, (@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))).*.num_mem));
    return 0;
}
pub fn onig_posix_regexec(arg_reg: [*c]onig_posix_regex_t, arg_str: [*c]const u8, arg_nmatch: usize, arg_pmatch: [*c]onig_posix_regmatch_t, arg_posix_options: c_int) callconv(.C) c_int {
    var reg = arg_reg;
    var str = arg_str;
    var nmatch = arg_nmatch;
    var pmatch = arg_pmatch;
    var posix_options = arg_posix_options;
    var r: c_int = undefined;
    var i: c_int = undefined;
    var len: c_int = undefined;
    var end: [*c]OnigUChar = undefined;
    var pm: [*c]onig_posix_regmatch_t = undefined;
    var options: OnigOptionType = undefined;
    options = (((((((((((@as(c_uint, 1) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1));
    if ((posix_options & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), 2))) != @as(c_int, 0)) options |= (((((((((@as(c_uint, 1) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1));
    if ((posix_options & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), 3))) != @as(c_int, 0)) options |= ((((((((((@as(c_uint, 1) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1)) << @intCast(@import("std").math.Log2Int(c_uint), 1));
    if ((nmatch == @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))) or ((reg.*.comp_options & (@as(c_int, 1) << @intCast(@import("std").math.Log2Int(c_int), 5))) != @as(c_int, 0))) {
        pm = @ptrCast([*c]onig_posix_regmatch_t, @alignCast(@alignOf(onig_posix_regmatch_t), (@intToPtr(?*c_void, @as(c_int, 0)))));
        nmatch = @bitCast(usize, @as(c_long, @as(c_int, 0)));
    } else if (@bitCast(c_int, @truncate(c_uint, nmatch)) < ((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))).*.num_mem + @as(c_int, 1))) {
        pm = @ptrCast([*c]onig_posix_regmatch_t, @alignCast(@alignOf(onig_posix_regmatch_t), malloc((@sizeOf(onig_posix_regmatch_t) *% @bitCast(c_ulong, @as(c_long, ((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))).*.num_mem + @as(c_int, 1))))))));
        if (pm == @ptrCast([*c]onig_posix_regmatch_t, @alignCast(@alignOf(onig_posix_regmatch_t), (@intToPtr(?*c_void, @as(c_int, 0)))))) return 12;
    } else {
        pm = pmatch;
    }
    while (true) {
        if ((((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))).*.enc).*.min_enc_len) == @as(c_int, 1)) {
            var tmps: [*c]OnigUChar = @intToPtr([*c]OnigUChar, @ptrToInt((str)));
            while (@bitCast(c_int, @as(c_uint, tmps.?.*)) != @as(c_int, 0)) tmps += 1;
            len = @bitCast(c_int, @truncate(c_int, (tmps - @intToPtr([*c]OnigUChar, @ptrToInt((str))))));
        } else {
            len = onigenc_str_bytelen_null((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))).*.enc, @intToPtr([*c]OnigUChar, @ptrToInt(str)));
        }
        if (!false) break;
    }
    end = @intToPtr([*c]OnigUChar, @ptrToInt((str + len)));
    r = onig_search((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))), @intToPtr([*c]OnigUChar, @ptrToInt(str)), end, @intToPtr([*c]OnigUChar, @ptrToInt(str)), end, @ptrCast([*c]OnigRegion, @alignCast(@alignOf(OnigRegion), pm)), options);
    if (r >= @as(c_int, 0)) {
        r = 0;
        if ((pm != pmatch) and (pm != @ptrCast([*c]onig_posix_regmatch_t, @alignCast(@alignOf(onig_posix_regmatch_t), (@intToPtr(?*c_void, @as(c_int, 0))))))) {
            _ = __builtin___memcpy_chk(@ptrCast(?*c_void, pmatch), @ptrCast(?*const c_void, pm), (@sizeOf(onig_posix_regmatch_t) *% nmatch), __builtin_object_size(@ptrCast(?*const c_void, pmatch), @as(c_int, 0)));
        }
    } else if (r == -@as(c_int, 1)) {
        r = 1;
        {
            i = 0;
            while (i < @bitCast(c_int, @truncate(c_uint, nmatch))) : (i += 1) pmatch[@intCast(c_uint, i)].rm_so = blk: {
                    const tmp = -@as(c_int, 1);
                    pmatch[@intCast(c_uint, i)].rm_eo = tmp;
                    break :blk tmp;
                };
        }
    } else {
    ...
    if ((pm != pmatch) and (pm != @ptrCast([*c]onig_posix_regmatch_t, @alignCast(@alignOf(onig_posix_regmatch_t), (@intToPtr(?*c_void, @as(c_int, 0))))))) free(@ptrCast(?*c_void, pm));
    return r;
}
pub fn onig_posix_regfree(arg_reg: [*c]onig_posix_regex_t) callconv(.C) void {
    var reg = arg_reg;
    onig_free((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))));
    reg.*.onig = @intToPtr(?*c_void, @as(c_int, 0));
}
pub extern fn onig_posix_regerror(code: c_int, reg: [*c]const onig_posix_regex_t, buf: [*c]u8, size: usize) usize;
pub fn onig_posix_reg_set_encoding(arg_mb_code: c_int) callconv(.C) void {
    var mb_code = arg_mb_code;
                ...
                case_7: {
                    case_5: {
                        case_3: {
                            case_1: {
                                case: {
                                    switch (mb_code) {
                                        ...
                                        @as(c_int, 3) => break :case_5,
                                        @as(c_int, 4) => break :case_7,
                                        @as(c_int, 5) => break :case_9,
                                        else => break :default,
                                    }
                                }
                            ...
                            enc = (&OnigEncodingEUC_JP);
                            break :switch_2;
                        }
                        enc = (&OnigEncodingSJIS);
                        break :switch_4;
                    }
                    enc = (&OnigEncodingUTF8);
                    break :switch_6;
                }
                enc = (&OnigEncodingUTF16_BE);
                break :switch_8;
            }
            enc = (&OnigEncodingUTF16_LE);
            break :switch_10;
        }
        return;
        break :switch_11;
    }
    _ = onig_initialize(&enc, @as(c_int, 1));
    _ = onigenc_set_default_encoding(enc);
}
pub fn onig_posix_reg_name_to_group_numbers(arg_reg: [*c]onig_posix_regex_t, arg_name: [*c]const u8, arg_name_end: [*c]const u8, arg_nums: [*c][*c]c_int) callconv(.C) c_int {
    var reg = arg_reg;
    var name = arg_name;
    var name_end = arg_name_end;
    var nums = arg_nums;
    return onig_name_to_group_numbers((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))), name, name_end, nums);
}
pub fn onig_posix_reg_foreach_name(arg_reg: [*c]onig_posix_regex_t, arg_func: ?fn ([*c]const u8, [*c]const u8, c_int, [*c]c_int, [*c]onig_posix_regex_t, ?*c_void) callconv(.C) c_int, arg_arg: ?*c_void) callconv(.C) c_int {
    var reg = arg_reg;
    var func = arg_func;
    var arg = arg_arg;
    var warg: i_wrap = undefined;
    warg.func = func;
    warg.reg = reg;
    warg.arg = arg;
    return onig_foreach_name((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))), i_wrapper, @ptrCast(?*c_void, &warg));
}
pub fn onig_posix_reg_number_of_names(arg_reg: [*c]onig_posix_regex_t) callconv(.C) c_int {
    var reg = arg_reg;
    return onig_number_of_names((@ptrCast([*c]onig_regex_t, @alignCast(@alignOf(onig_regex_t), ((reg).*.onig)))));
}
const struct_unnamed_77 = extern struct {
    onig_err: c_int,
    posix_err: c_int,
};
pub const O2PERR = struct_unnamed_77;
const o2p: [75]O2PERR = [75]O2PERR{
    O2PERR{
        .onig_err = -@as(c_int, 1),
        .posix_err = @as(c_int, 1),
    },
    O2PERR{
        .onig_err = -@as(c_int, 2),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 3),
        .posix_err = @as(c_int, 14),
    ...
    O2PERR{
        .onig_err = -@as(c_int, 5),
        .posix_err = @as(c_int, 12),
    },
    O2PERR{
        .onig_err = -@as(c_int, 15),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 17),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 18),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 19),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 6),
    ...
    O2PERR{
        .onig_err = -@as(c_int, 11),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 12),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 13),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 14),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 21),
        .posix_err = @as(c_int, 16),
    },
    O2PERR{
        .onig_err = -@as(c_int, 22),
        .posix_err = @as(c_int, 16),
    },
    O2PERR{
        .onig_err = -@as(c_int, 23),
        .posix_err = @as(c_int, 14),
    },
    O2PERR{
        .onig_err = -@as(c_int, 30),
        .posix_err = @as(c_int, 16),
    },
    O2PERR{
        .onig_err = -@as(c_int, 100),
        .posix_err = @as(c_int, 9),
    },
    O2PERR{
        .onig_err = -@as(c_int, 101),
        .posix_err = @as(c_int, 7),
    },
    O2PERR{
        .onig_err = -@as(c_int, 102),
        .posix_err = @as(c_int, 4),
    },
    O2PERR{
        .onig_err = -@as(c_int, 103),
        .posix_err = @as(c_int, 4),
    },
    O2PERR{
        .onig_err = -@as(c_int, 104),
        .posix_err = @as(c_int, 5),
    },
    O2PERR{
        .onig_err = -@as(c_int, 105),
        .posix_err = @as(c_int, 5),
    },
    O2PERR{
        .onig_err = -@as(c_int, 106),
        .posix_err = @as(c_int, 5),
    },
    O2PERR{
        .onig_err = -@as(c_int, 108),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 109),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 110),
        .posix_err = @as(c_int, 4),
    },
    O2PERR{
        .onig_err = -@as(c_int, 111),
        .posix_err = @as(c_int, 4),
    },
    O2PERR{
        .onig_err = -@as(c_int, 112),
        .posix_err = @as(c_int, 4),
    },
    O2PERR{
        .onig_err = -@as(c_int, 113),
        .posix_err = @as(c_int, 13),
    },
    O2PERR{
        .onig_err = -@as(c_int, 114),
        .posix_err = @as(c_int, 13),
    },
    O2PERR{
        .onig_err = -@as(c_int, 115),
        .posix_err = @as(c_int, 13),
    },
    O2PERR{
        .onig_err = -@as(c_int, 116),
        .posix_err = @as(c_int, 8),
    },
    O2PERR{
        .onig_err = -@as(c_int, 117),
        .posix_err = @as(c_int, 8),
    },
    O2PERR{
        .onig_err = -@as(c_int, 118),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 119),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 121),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 122),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 123),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 200),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 201),
        .posix_err = @as(c_int, 10),
    },
    O2PERR{
        .onig_err = -@as(c_int, 202),
        .posix_err = @as(c_int, 10),
    },
    O2PERR{
        .onig_err = -@as(c_int, 203),
        .posix_err = @as(c_int, 4),
    },
    O2PERR{
        .onig_err = -@as(c_int, 204),
        .posix_err = @as(c_int, 4),
    },
    O2PERR{
        .onig_err = -@as(c_int, 205),
        .posix_err = @as(c_int, 4),
    },
    O2PERR{
        .onig_err = -@as(c_int, 206),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 207),
        .posix_err = @as(c_int, 6),
    },
    O2PERR{
        .onig_err = -@as(c_int, 208),
        .posix_err = @as(c_int, 6),
    },
    O2PERR{
        .onig_err = -@as(c_int, 209),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 401),
        .posix_err = @as(c_int, 15),
    },
    O2PERR{
        .onig_err = -@as(c_int, 212),
        .posix_err = @as(c_int, 15),
    },
    O2PERR{
        .onig_err = -@as(c_int, 213),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 400),
        .posix_err = @as(c_int, 15),
    },
    O2PERR{
        .onig_err = -@as(c_int, 214),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 215),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 216),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 217),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 218),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 219),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 220),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 221),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 222),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 223),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 224),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 225),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 226),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 227),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 228),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 229),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 230),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 231),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 232),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 402),
        .posix_err = @as(c_int, 16),
    },
    O2PERR{
        .onig_err = -@as(c_int, 406),
        .posix_err = @as(c_int, 2),
    },
    O2PERR{
        .onig_err = -@as(c_int, 500),
        .posix_err = @as(c_int, 14),
    },
};
pub fn onig2posix_error_code(arg_code: c_int) callconv(.C) c_int {
    var code = arg_code;
    _ = o2p;
    var i: c_int = undefined;
    if (code >= @as(c_int, 0)) return 0;
    {
        i = 0;
        while (i < @bitCast(c_int, @truncate(c_uint, (@sizeOf([75]O2PERR) / @sizeOf(O2PERR))))) : (i += 1) {
            if (code == o2p[@intCast(c_uint, i)].onig_err) return o2p[@intCast(c_uint, i)].posix_err;
        }
    }
    return 14;
}
const struct_unnamed_78 = extern struct {
    func: ?fn ([*c]const u8, [*c]const u8, c_int, [*c]c_int, [*c]onig_posix_regex_t, ?*c_void) callconv(.C) c_int,
    reg: [*c]onig_posix_regex_t,
    arg: ?*c_void,
};
pub const i_wrap = struct_unnamed_78;
pub fn i_wrapper(arg_name: [*c]const OnigUChar, arg_name_end: [*c]const OnigUChar, arg_ng: c_int, arg_gs: [*c]c_int, arg_reg: [*c]onig_regex_t, arg_arg: ?*c_void) callconv(.C) c_int {
    var name = arg_name;
    var name_end = arg_name_end;
    var ng = arg_ng;
    var gs = arg_gs;
    var reg = arg_reg;
    var arg = arg_arg;
    var warg: [*c]i_wrap = @ptrCast([*c]i_wrap, @alignCast(@alignOf(i_wrap), arg));
...
pub const PONIG_C = @compileError("unable to translate C expr: unexpected token .RParen"); // ../oniguruma/src/regposix.c:49:9
pub const ENC_STRING_LEN = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ../oniguruma/src/regposix.c:52:9
...
pub const _DEBUG = 1;
pub const regex_t = onig_regex_t;
...
pub fn ONIG_C(reg: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast([*c]onig_regex_t, reg.*.onig))) {
    return (@import("std").meta.cast([*c]onig_regex_t, reg.*.onig));
}
