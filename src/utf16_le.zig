...
pub fn init() callconv(.C) c_int {
    ...
    var args: [4]c_uint = undefined;
    var opts: [4]OnigValue = undefined;
    enc = (&OnigEncodingUTF16_LE);
    name = "F\x00A\x00I\x00L\x00\x00\x00";
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
        id = onig_set_callout_of_name(enc, @intToEnum(OnigCalloutType, ONIG_CALLOUT_TYPE_SINGLE), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (name))), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), ((name) + len))), ONIG_CALLOUT_IN_PROGRESS, onig_builtin_fail, null, @as(c_int, 0), null, @as(c_int, 0), null);
        if (id < @as(c_int, 0)) return id;
        if (!false) break;
    }
    name = "M\x00I\x00S\x00M\x00A\x00T\x00C\x00H\x00\x00\x00";
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
        id = onig_set_callout_of_name(enc, @intToEnum(OnigCalloutType, ONIG_CALLOUT_TYPE_SINGLE), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (name))), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), ((name) + len))), ONIG_CALLOUT_IN_PROGRESS, onig_builtin_mismatch, null, @as(c_int, 0), null, @as(c_int, 0), null);
        if (id < @as(c_int, 0)) return id;
        if (!false) break;
    }
    name = "M\x00A\x00X\x00\x00\x00";
    args[@intCast(c_uint, @as(c_int, 0))] = @bitCast(c_uint, (ONIG_TYPE_TAG | ONIG_TYPE_LONG));
    args[@intCast(c_uint, @as(c_int, 1))] = @bitCast(c_uint, ONIG_TYPE_CHAR);
    opts[@intCast(c_uint, @as(c_int, 0))].c = @bitCast(OnigCodePoint, @as(c_int, 'X'));
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
        id = onig_set_callout_of_name(enc, @intToEnum(OnigCalloutType, ONIG_CALLOUT_TYPE_SINGLE), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (name))), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), ((name) + len))), (ONIG_CALLOUT_IN_PROGRESS | ONIG_CALLOUT_IN_RETRACTION), onig_builtin_max, null, (@as(c_int, 2)), &(args), (@as(c_int, 1)), &(opts));
        if (id < @as(c_int, 0)) return id;
        if (!false) break;
    }
    name = "E\x00R\x00R\x00O\x00R\x00\x00\x00";
    args[@intCast(c_uint, @as(c_int, 0))] = @bitCast(c_uint, ONIG_TYPE_LONG);
    opts[@intCast(c_uint, @as(c_int, 0))].l = @bitCast(c_long, @as(c_long, -@as(c_int, 3)));
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
        id = onig_set_callout_of_name(enc, @intToEnum(OnigCalloutType, ONIG_CALLOUT_TYPE_SINGLE), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (name))), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), ((name) + len))), ONIG_CALLOUT_IN_PROGRESS, onig_builtin_error, null, (@as(c_int, 1)), &(args), (@as(c_int, 1)), &(opts));
        if (id < @as(c_int, 0)) return id;
        if (!false) break;
    }
    name = "C\x00O\x00U\x00N\x00T\x00\x00\x00";
    args[@intCast(c_uint, @as(c_int, 0))] = @bitCast(c_uint, ONIG_TYPE_CHAR);
    opts[@intCast(c_uint, @as(c_int, 0))].c = @bitCast(OnigCodePoint, @as(c_int, '>'));
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
        id = onig_set_callout_of_name(enc, @intToEnum(OnigCalloutType, ONIG_CALLOUT_TYPE_SINGLE), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (name))), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), ((name) + len))), (ONIG_CALLOUT_IN_PROGRESS | ONIG_CALLOUT_IN_RETRACTION), onig_builtin_count, null, (@as(c_int, 1)), &(args), (@as(c_int, 1)), &(opts));
        if (id < @as(c_int, 0)) return id;
        if (!false) break;
    }
    name = "T\x00O\x00T\x00A\x00L\x00_\x00C\x00O\x00U\x00N\x00T\x00\x00\x00";
    args[@intCast(c_uint, @as(c_int, 0))] = @bitCast(c_uint, ONIG_TYPE_CHAR);
    opts[@intCast(c_uint, @as(c_int, 0))].c = @bitCast(OnigCodePoint, @as(c_int, '>'));
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
        id = onig_set_callout_of_name(enc, @intToEnum(OnigCalloutType, ONIG_CALLOUT_TYPE_SINGLE), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (name))), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), ((name) + len))), (ONIG_CALLOUT_IN_PROGRESS | ONIG_CALLOUT_IN_RETRACTION), onig_builtin_total_count, null, (@as(c_int, 1)), &(args), (@as(c_int, 1)), &(opts));
        if (id < @as(c_int, 0)) return id;
        if (!false) break;
    }
    name = "C\x00M\x00P\x00\x00\x00";
    args[@intCast(c_uint, @as(c_int, 0))] = @bitCast(c_uint, (ONIG_TYPE_TAG | ONIG_TYPE_LONG));
    args[@intCast(c_uint, @as(c_int, 1))] = @bitCast(c_uint, ONIG_TYPE_STRING);
    args[@intCast(c_uint, @as(c_int, 2))] = @bitCast(c_uint, (ONIG_TYPE_TAG | ONIG_TYPE_LONG));
    while (true) {
        var len: c_int = onigenc_str_bytelen_null(enc, @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), name)));
        id = onig_set_callout_of_name(enc, @intToEnum(OnigCalloutType, ONIG_CALLOUT_TYPE_SINGLE), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), (name))), @ptrCast([*c]OnigUChar, @alignCast(@alignOf(OnigUChar), ((name) + len))), ONIG_CALLOUT_IN_PROGRESS, onig_builtin_cmp, null, (@as(c_int, 3)), &(args), @as(c_int, 0), null);
        if (id < @as(c_int, 0)) return id;
        if (!false) break;
    }
    return 0;
}
pub const EncLen_UTF16: [256]c_int = [256]c_int{
    @as(c_int, 2),
    @as(c_int, 2),
    @as(c_int, 2),
    @as(c_int, 2),
...
pub fn utf16le_code_to_mbclen(arg_code: OnigCodePoint) callconv(.C) c_int {
    var code = arg_code;
    if (code > @bitCast(c_uint, @as(c_int, 65535))) {
        if (code > @bitCast(c_uint, @as(c_int, 1114111))) return -@as(c_int, 400) else return 4;
    } else {
        return 2;
    }
    return 0;
}
pub fn utf16le_mbc_enc_len(arg_p: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
    return EncLen_UTF16[(p + @as(c_int, 1)).?.*];
}
pub fn is_valid_mbc_string(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
    var end = arg_end;
    var end1: [*c]const OnigUChar = (end - @as(c_int, 1));
    while (p < end1) {
        var len: c_int = utf16le_mbc_enc_len(p);
        if (len == @as(c_int, 4)) {
            if (((p + @as(c_int, 3)) < end) and !((@bitCast(c_int, @as(c_uint, ((p + @as(c_int, 3)).?.*))) & @as(c_int, 252)) == @as(c_int, 220))) return 0;
        } else if ((@bitCast(c_int, @as(c_uint, ((p + @as(c_int, 1)).?.*))) & @as(c_int, 252)) == @as(c_int, 220)) return 0;
        p += len;
    }
    if (p != end) return 0 else return 1;
    return 0;
}
pub fn utf16le_is_mbc_newline(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) c_int {
    var p = arg_p;
    var end = arg_end;
    if ((p + @as(c_int, 1)) < end) {
        if ((@bitCast(c_int, @as(c_uint, p.?.*)) == @as(c_int, 10)) and (@bitCast(c_int, @as(c_uint, (p + @as(c_int, 1)).?.*)) == @as(c_int, 0))) return 1;
    }
    return 0;
}
pub fn utf16le_mbc_to_code(arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar) callconv(.C) OnigCodePoint {
    var p = arg_p;
    var end = arg_end;
    var code: OnigCodePoint = undefined;
    var c0: OnigUChar = p.?.*;
    var c1: OnigUChar = (p + @as(c_int, 1)).?.*;
    if ((@bitCast(c_int, @as(c_uint, (c1))) & @as(c_int, 252)) == @as(c_int, 216)) {
        code = @bitCast(OnigCodePoint, (((((((@bitCast(c_int, @as(c_uint, c1)) - @as(c_int, 216)) << @intCast(@import("std").math.Log2Int(c_int), 2)) + ((@bitCast(c_int, @as(c_uint, c0)) & @as(c_int, 192)) >> @intCast(@import("std").math.Log2Int(c_int), 6))) + @as(c_int, 1)) << @intCast(@import("std").math.Log2Int(c_int), 16)) + ((((@bitCast(c_int, @as(c_uint, c0)) & @as(c_int, 63)) << @intCast(@import("std").math.Log2Int(c_int), 2)) + (@bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 3))])) - @as(c_int, 220))) << @intCast(@import("std").math.Log2Int(c_int), 8))) + @bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 2))]))));
    } else {
        code = @bitCast(OnigCodePoint, ((@bitCast(c_int, @as(c_uint, c1)) * @as(c_int, 256)) + @bitCast(c_int, @as(c_uint, p[@intCast(c_uint, @as(c_int, 0))]))));
    }
    return code;
}
pub fn utf16le_code_to_mbc(arg_code: OnigCodePoint, arg_buf: [*c]OnigUChar) callconv(.C) c_int {
    var code = arg_code;
    var buf = arg_buf;
    var p: [*c]OnigUChar = buf;
    if (code > @bitCast(c_uint, @as(c_int, 65535))) {
        var plane: c_uint = undefined;
        var high: c_uint = undefined;
        plane = ((code >> @intCast(@import("std").math.Log2Int(OnigCodePoint), 16)) -% @bitCast(c_uint, @as(c_int, 1)));
        high = (code & @bitCast(c_uint, @as(c_int, 65280))) >> @intCast(@import("std").math.Log2Int(c_uint), 8);
        (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }).?.* = @bitCast(OnigUChar, @truncate(u8, (((plane & @bitCast(c_uint, @as(c_int, 3))) << @intCast(@import("std").math.Log2Int(c_uint), 6)) +% (high >> @intCast(@import("std").math.Log2Int(c_uint), 2)))));
        (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }).?.* = @bitCast(OnigUChar, @truncate(u8, ((plane >> @intCast(@import("std").math.Log2Int(c_uint), 2)) +% @bitCast(c_uint, @as(c_int, 216)))));
        (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
        ...
        p.?.* = @bitCast(OnigUChar, @truncate(u8, ((high & @bitCast(c_uint, @as(c_int, 3))) +% @bitCast(c_uint, @as(c_int, 220)))));
        return 4;
    } else {
        (blk: {
            const ref = &p;
        ...
        p.?.* = @bitCast(OnigUChar, @truncate(u8, ((code & @bitCast(c_uint, @as(c_int, 65280))) >> @intCast(@import("std").math.Log2Int(c_uint), 8))));
        return 2;
    }
    return 0;
}
pub fn utf16le_mbc_case_fold(arg_flag: OnigCaseFoldType, arg_pp: [*c][*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_fold: [*c]OnigUChar) callconv(.C) c_int {
    var flag = arg_flag;
    var pp = arg_pp;
    var end = arg_end;
    var fold = arg_fold;
    var p: [*c]const OnigUChar = pp.?.*;
    if ((@bitCast(c_int, @as(c_uint, (p.?.*))) < @as(c_int, 128)) and (@bitCast(c_int, @as(c_uint, (p + @as(c_int, 1)).?.*)) == @as(c_int, 0))) {
        (blk: {
            const ref = &fold;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }).?.* = OnigEncAsciiToLowerCaseTable[p.?.*];
        fold.?.* = @bitCast(OnigUChar, @truncate(i8, @as(c_int, 0)));
        pp.?.* += @as(c_int, 2);
        return 2;
    } else return onigenc_unicode_mbc_case_fold((&OnigEncodingUTF16_LE), flag, pp, end, fold);
    return 0;
}
pub fn utf16le_left_adjust_char_head(arg_start: [*c]const OnigUChar, arg_s: [*c]const OnigUChar) callconv(.C) [*c]OnigUChar {
    var start = arg_start;
    var s = arg_s;
    if (s <= start) return @intToPtr([*c]OnigUChar, @ptrToInt(s));
    if (@rem((s - start), @bitCast(c_long, @as(c_long, @as(c_int, 2)))) == @bitCast(c_long, @as(c_long, @as(c_int, 1)))) {
        s -= 1;
    }
    if ((((@bitCast(c_int, @as(c_uint, ((s + @as(c_int, 1)).?.*))) & @as(c_int, 252)) == @as(c_int, 220)) and (s > (start + @as(c_int, 1)))) and ((@bitCast(c_int, @as(c_uint, ((s - @as(c_int, 1)).?.*))) & @as(c_int, 252)) == @as(c_int, 216))) s -= @as(c_int, 2);
    return @intToPtr([*c]OnigUChar, @ptrToInt(s));
}
pub fn utf16le_get_case_fold_codes_by_str(arg_flag: OnigCaseFoldType, arg_p: [*c]const OnigUChar, arg_end: [*c]const OnigUChar, arg_items: [*c]OnigCaseFoldCodeItem) callconv(.C) c_int {
    var flag = arg_flag;
    var p = arg_p;
    var end = arg_end;
    var items = arg_items;
    return onigenc_unicode_get_case_fold_codes_by_str((&OnigEncodingUTF16_LE), flag, p, end, items);
}
