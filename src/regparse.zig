...
} // ./src/todo/regparse.c:4297:7: warning: TODO implement translation of stmt class GotoStmtClass
pub const onig_reduce_nested_quantifier = @compileError("unable to translate function"); // ./src/todo/regparse.c:4278:1
// ./src/todo/regparse.c:2197:3: warning: TODO complex switch cases
pub const onig_node_copy = @compileError("unable to translate function"); // ./src/todo/regparse.c:2182:1
...
pub const CS_VALUE = @enumToInt(enum_unnamed_97.CS_VALUE);
pub const CS_RANGE = @enumToInt(enum_unnamed_97.CS_RANGE);
pub const CS_COMPLETE = @enumToInt(enum_unnamed_97.CS_COMPLETE);
pub const CS_START = @enumToInt(enum_unnamed_97.CS_START);
...
pub const CSTATE = enum_unnamed_97;
pub const CV_UNDEF = @enumToInt(enum_unnamed_98.CV_UNDEF);
pub const CV_SB = @enumToInt(enum_unnamed_98.CV_SB);
pub const CV_MB = @enumToInt(enum_unnamed_98.CV_MB);
pub const CV_CPROP = @enumToInt(enum_unnamed_98.CV_CPROP);
...
pub const CVAL = enum_unnamed_98;
...
pub const st_str_end_key = struct_unnamed_99;
...
pub const st_callout_name_key = struct_unnamed_100;
...
pub const NameEntry = struct_unnamed_101;
...
pub const INamesArg = struct_unnamed_102;
...
pub const CalloutNameListEntry = struct_unnamed_103;
const struct_unnamed_104 = extern struct {
    n: c_int,
    alloc: c_int,
    v: [*c]CalloutNameListEntry,
};
pub const CalloutNameListType = struct_unnamed_104;
...
pub const CalloutNameEntry = struct_unnamed_105;
...
pub fn node_new_callout(arg_node: [*c][*c]Node, arg_callout_of: OnigCalloutOf, arg_num: c_int, arg_id: c_int, arg_env: [*c]ParseEnv) callconv(.C) c_int {
    ...
    return 0;
} // ./src/todo/regparse.c:2828:23: warning: TODO implement translation of stmt class GotoStmtClass
pub const make_text_segment = @compileError("unable to translate function"); // ./src/todo/regparse.c:2815:1
// ./src/todo/regparse.c:2885:15: warning: TODO implement translation of stmt class GotoStmtClass
pub const make_absent_engine = @compileError("unable to translate function"); // ./src/todo/regparse.c:2870:1
// ./src/todo/regparse.c:2966:15: warning: TODO implement translation of stmt class GotoStmtClass
pub const make_absent_tail = @compileError("unable to translate function"); // ./src/todo/regparse.c:2953:1
// ./src/todo/regparse.c:3014:15: warning: TODO implement translation of stmt class GotoStmtClass
pub const make_range_clear = @compileError("unable to translate function"); // ./src/todo/regparse.c:3002:1
pub fn is_simple_one_char_repeat(arg_node: [*c]Node, arg_rquant: [*c][*c]Node, arg_rbody: [*c][*c]Node, arg_is_possessive: [*c]c_int, arg_env: [*c]ParseEnv) callconv(.C) c_int {
    ...
    rbody.?.* = body;
    return 1;
} // ./src/todo/regparse.c:3146:15: warning: TODO implement translation of stmt class GotoStmtClass
pub const make_absent_tree_for_simple_one_char_repeat = @compileError("unable to translate function"); // ./src/todo/regparse.c:3127:1
// ./src/todo/regparse.c:3195:27: warning: TODO implement translation of stmt class GotoStmtClass
pub const make_absent_tree = @compileError("unable to translate function"); // ./src/todo/regparse.c:3174:1
...
pub const check_code_point_sequence_cc = @compileError("unable to translate function"); // ./src/todo/regparse.c:3590:1
// ./src/todo/regparse.c:3669:5: warning: TODO implement translation of stmt class LabelStmtClass
pub const check_code_point_sequence = @compileError("unable to translate function"); // ./src/todo/regparse.c:3655:1
...
} // ./src/todo/regparse.c:3868:3: warning: TODO implement translation of stmt class LabelStmtClass
pub const not_code_range_buf = @compileError("unable to translate function"); // ./src/todo/regparse.c:3861:1
...
}; // ./src/todo/regparse.c:4364:21: warning: TODO implement translation of stmt class GotoStmtClass
pub const node_new_general_newline = @compileError("unable to translate function"); // ./src/todo/regparse.c:4345:1
...
const union_unnamed_107 = extern union {
    ...
    anchor: c_int,
    subtype: c_int,
    repeat: struct_unnamed_108,
    backref: struct_unnamed_109,
    call: struct_unnamed_110,
    prop: struct_unnamed_111,
};
...
pub const PToken = struct_unnamed_106;
pub fn ptoken_init(arg_tok: [*c]PToken) callconv(.C) void {
    var tok = arg_tok;
    tok.*.code_point_continue = 0;
} // ./src/todo/regparse.c:4514:7: warning: TODO implement translation of stmt class GotoStmtClass
pub const fetch_interval = @compileError("unable to translate function"); // ./src/todo/regparse.c:4477:1
// ./src/todo/regparse.c:4606:7: warning: TODO implement translation of stmt class GotoStmtClass
pub const fetch_escaped_value_raw = @compileError("unable to translate function"); // ./src/todo/regparse.c:4580:1
pub fn fetch_escaped_value(arg_src: [*c][*c]OnigUChar, arg_end: [*c]OnigUChar, arg_env: [*c]ParseEnv, arg_val: [*c]OnigCodePoint) callconv(.C) c_int {
    ...
    return 0;
} // ./src/todo/regparse.c:5370:7: warning: TODO implement translation of stmt class GotoStmtClass
pub const fetch_token = @compileError("unable to translate function"); // ./src/todo/regparse.c:5344:1
...
pub const fetch_name_with_level = @compileError("unable to translate function"); // ./src/todo/regparse.c:4696:1
// ./src/todo/regparse.c:4926:7: warning: TODO implement translation of stmt class GotoStmtClass
pub const fetch_name = @compileError("unable to translate function"); // ./src/todo/regparse.c:4830:1
...
pub fn str_exist_check_with_esc(arg_s: [*c]OnigCodePoint, arg_n: c_int, arg_from: [*c]OnigUChar, arg_to: [*c]OnigUChar, arg_bad: OnigCodePoint, arg_enc: OnigEncoding, arg_syn: [*c]OnigSyntaxType) callconv(.C) c_int {
    ...
    return 0;
} // ./src/todo/regparse.c:5079:7: warning: TODO implement translation of stmt class GotoStmtClass
pub const fetch_token_cc = @compileError("unable to translate function"); // ./src/todo/regparse.c:5060:1
// ./src/todo/regparse.c:6227:11: warning: TODO implement translation of stmt class GotoStmtClass
pub const add_ctype_to_cc_by_range = @compileError("unable to translate function"); // ./src/todo/regparse.c:6206:1
// ./src/todo/regparse.c:6295:24: warning: TODO implement translation of stmt class GotoStmtClass
pub const add_ctype_to_cc_by_range_limit = @compileError("unable to translate function"); // ./src/todo/regparse.c:6279:1
// ./src/todo/regparse.c:6409:3: warning: TODO complex switch cases
pub const add_ctype_to_cc = @compileError("unable to translate function"); // ./src/todo/regparse.c:6372:1
// ./src/todo/regparse.c:6512:5: warning: TODO implement translation of stmt class GotoStmtClass
...
pub const prs_posix_bracket = @compileError("unable to translate function"); // ./src/todo/regparse.c:6475:1
...
pub fn cc_cprop_next(arg_cc: [*c]CClassNode, arg_pcode: [*c]OnigCodePoint, arg_val: [*c]CVAL, arg_state: [*c]CSTATE, arg_env: [*c]ParseEnv) callconv(.C) c_int {
    ...
    return 0;
} // ./src/todo/regparse.c:6656:13: warning: TODO implement translation of stmt class GotoStmtClass
pub const cc_char_next = @compileError("unable to translate function"); // ./src/todo/regparse.c:6628:1
pub fn code_exist_check(arg_c: OnigCodePoint, arg_from: [*c]OnigUChar, arg_end: [*c]OnigUChar, arg_ignore_escaped: c_int, arg_env: [*c]ParseEnv) callconv(.C) c_int {
    ...
    return 0;
} // ./src/todo/regparse.c:6770:5: warning: TODO implement translation of stmt class LabelStmtClass
pub const prs_cc = @compileError("unable to translate function"); // ./src/todo/regparse.c:6721:1
// ./src/todo/regparse.c:9000:7: warning: TODO implement translation of stmt class GotoStmtClass
pub const prs_alts = @compileError("unable to translate function"); // ./src/todo/regparse.c:8953:1
...
} // ./src/todo/regparse.c:7293:9: warning: TODO implement translation of stmt class GotoStmtClass
pub const prs_callout_args = @compileError("unable to translate function"); // ./src/todo/regparse.c:7261:1
// ./src/todo/regparse.c:7511:7: warning: TODO implement translation of stmt class GotoStmtClass
pub const prs_callout_of_name = @compileError("unable to translate function"); // ./src/todo/regparse.c:7426:1
// ./src/todo/regparse.c:7618:5: warning: TODO implement translation of stmt class LabelStmtClass
pub const prs_bag = @compileError("unable to translate function"); // ./src/todo/regparse.c:7593:1
...
pub var ReduceQStr: [7][*c]const u8 = [7][*c]const u8{
    ...
    "+ and ??",
    "+? and ?",
}; // ./src/todo/regparse.c:8273:11: warning: TODO implement translation of stmt class GotoStmtClass
pub const assign_quantifier_body = @compileError("unable to translate function"); // ./src/todo/regparse.c:8229:1
...
pub const IApplyCaseFoldArg = struct_unnamed_112;
pub const i_apply_case_fold = @compileError("unable to translate function"); // ./src/todo/regparse.c:8384:1
// ./src/todo/regparse.c:8504:2: warning: TODO implement translation of stmt class LabelStmtClass
pub const prs_exp = @compileError("unable to translate function"); // ./src/todo/regparse.c:8496:1
...
pub const ST_NUMCMP = @compileError("unable to translate C expr: unexpected token .RParen"); // ./src/todo/st.h:61:9
pub const ST_NUMHASH = @compileError("unable to translate C expr: unexpected token .RParen"); // ./src/todo/st.h:62:9
pub const INC_PARSE_DEPTH = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:247:9
pub const DEC_PARSE_DEPTH = @compileError("TODO postfix inc/dec expr"); // ./src/todo/regparse.c:254:9
pub const OPTION_ON = @compileError("unable to translate C expr: expected ')' instead got: PipeEqual"); // ./src/todo/regparse.c:315:9
pub const OPTION_OFF = @compileError("unable to translate C expr: expected ')' instead got: AmpersandEqual"); // ./src/todo/regparse.c:316:9
pub const OPTION_NEGATE = @compileError("unable to translate C expr: expected ')' instead got: AmpersandEqual"); // ./src/todo/regparse.c:318:9
pub const ADD_ALL_MULTI_BYTE_RANGE = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:326:9
pub const BITSET_IS_EMPTY = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:334:9
pub const PUNFETCH = @compileError("unable to translate C expr: unexpected token .Equal"); // ./src/todo/regparse.c:415:9
pub const PINC = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:416:9
pub const PFETCH = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:420:9
pub const PINC_S = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:426:9
pub const PFETCH_S = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:429:9
pub const SWAP_BB_NOT = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:3899:9
pub const ADD_CODE_INTO_CC = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // ./src/todo/regparse.c:8344:9
